...
// 
// Microsoft.VSDesigner generó automáticamente este código fuente, versión=1.1.4322.2032.
// 
namespace NEGOCIO_SIC_SANS.SimCardsWS {
    ...
    public class ebsSimcards : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ebsSimcards() {
            this.Url = "http://limdeseaiv30.tim.com.pe:8909/SimcardsWS/ebsSimcards";
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginactualizarSimcardPorReposicion(string idTransaccion, string ipAplicacion, string nombreAplicacion, string usuarioAplicacion, string nroTelef, string nroSerie, string descripcionProducto, string usuario, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("actualizarSimcardPorReposicion", new object[] {
                        idTransaccion,
                        ipAplicacion,
                        nombreAplicacion,
                        usuarioAplicacion,
        ...
        /// <remarks/>
        public string EndactualizarSimcardPorReposicion(System.IAsyncResult asyncResult, out string idTransaccion, out string mensajeResultado, out itReturnType[] itReturn) {
            object[] results = this.EndInvoke(asyncResult);
            idTransaccion = ((string)(results[1]));
            mensajeResultado = ((string)(results[2]));
            itReturn = ((itReturnType[])(results[3]));
        ...
        /// <remarks/>
        public System.IAsyncResult BeginasociarNroTelefSerie(string idTransaccion, string ipAplicacion, string nombreAplicacion, string usuarioAplicacion, string nroTelef, string nroSerie, string material, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("asociarNroTelefSerie", new object[] {
                        idTransaccion,
                        ipAplicacion,
                        nombreAplicacion,
                        usuarioAplicacion,
        ...
        /// <remarks/>
        public string EndasociarNroTelefSerie(System.IAsyncResult asyncResult, out string idTransaccion, out string mensajeResultado, out itWorkType[] itOutput, out itReturnType[] itReturn) {
            object[] results = this.EndInvoke(asyncResult);
            idTransaccion = ((string)(results[1]));
            mensajeResultado = ((string)(results[2]));
            itOutput = ((itWorkType[])(results[3]));
        ...
        /// <remarks/>
        public System.IAsyncResult BegindesasociarNroTelefSerie(string idTransaccion, string ipAplicacion, string nombreAplicacion, string usuarioAplicacion, string nroTelef, string nroSerie, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("desasociarNroTelefSerie", new object[] {
                        idTransaccion,
                        ipAplicacion,
                        nombreAplicacion,
                        usuarioAplicacion,
        ...
        /// <remarks/>
        public string EnddesasociarNroTelefSerie(System.IAsyncResult asyncResult, out string idTransaccion, out string mensajeResultado, out itReturnType[] itReturn) {
            object[] results = this.EndInvoke(asyncResult);
            idTransaccion = ((string)(results[1]));
            mensajeResultado = ((string)(results[2]));
            itReturn = ((itReturnType[])(results[3]));
