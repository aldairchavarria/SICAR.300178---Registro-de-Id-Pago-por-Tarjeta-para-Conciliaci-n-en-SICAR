<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AnulfReut.aspx.vb" Inherits="SisCajas.AnulfReut" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>AnulfReut</title>
								...
								<td width="98%" style="PADDING-RIGHT:5px; PADDING-LEFT:5px; PADDING-BOTTOM:5px; PADDING-TOP:5px">
									<table border="0" cellspacing="2" cellpadding="0" align="center" class="Arial12B" width="80%">
										...
										<tr>
											...
											<td><input class="clsInputEnable" type="text" name="txtMotivo" size="40" maxlength="40" runat="server"
													id="txtMotivo"></td>
										</tr>
									</table>
								</td>
