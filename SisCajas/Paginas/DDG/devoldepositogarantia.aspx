<%@ Page Language="vb" AutoEventWireup="false" Codebehind="devoldepositogarantia.aspx.vb" Inherits="SisCajas.devoldepositogarantia" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Devolución Deposito en Garantia</title>
...
function f_Buscar(){
	...
	window.open(Direcc,"Datos","directories=no,menubar=no,scrollbars=no,top=200,resizable=yes,left=185,width=550,height=250");
}
