<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NuevoTurno.aspx.vb" Inherits="SisCajas.NuevoTurno" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="frmTurno" method="post" runat="server">
			<table borderColor="#336699" cellSpacing="0" cellPadding="4" width="410" align="center"
				border="1">
				<tr>
					<td align="center"><asp:label class="TituloConsulta" id="lblTitActualizaBIN" runat="server">Actualizacion de Turnos</asp:label></td>
				</tr>
			</table>
			<br>
			<table borderColor="#336699" cellSpacing="0" cellPadding="4" width="375" align="center"
				...
				<tr>
					...
					<td class="Arial12b"><input class="clsInputEnable" onkeypress="f_Numeros()" id="txtTolerancia" style="WIDTH:50px"
							type="text" maxLength="2" size="25" name="txtTolerancia" runat="server">&nbsp;&nbsp;&nbsp;(minutos)</td>
				</tr>
				<tr>
