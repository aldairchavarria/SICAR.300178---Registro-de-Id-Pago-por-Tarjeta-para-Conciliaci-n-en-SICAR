<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NuevoPermisoTrans.aspx.vb" Inherits="SisCajas.NuevoPermisoTrans"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>NuevoPermisoTrans</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table width="375" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#336699">
				<tr>
					<td align="center">
						<asp:Label id="lblTitActualizaBIN" runat="server" class="TituloConsulta">Nuevo BIN</asp:Label>
					</td>
				</tr>
			</table>
			<br>
			<table width="350" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#336699">
				...
				<tr>
					...
					<td><select id="selEstado" border="0" class="Arial12b" runat="server" NAME="selEstado">
