...
#Region " Código generado por el Diseñador de Web Forms "
    ...
    End Sub
    Protected WithEvents DGListaBin As System.Web.UI.WebControls.DataGrid
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            'orComando.Parameters(2).Direction = ParameterDirection.Output

            'orComando.CommandText = "CONF_PARAMETROS_CAJA.CONF_LISTA_BIN"
            'orComando.CommandType = CommandType.StoredProcedure

            'orDataAd.SelectCommand = orComando

            'orDataAd.Fill(dsData)
            dsData = objConfig.FP_Lista_BIN(Session("CANAL"), ConfigurationSettings.AppSettings("codAplicacion"))

            DGListaBin.DataSource = dsData.Tables(0)

        DGListaBin.DataBind()
        End If
    End Sub

    Private Sub DGListaBin_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DGListaBin.SelectedIndexChanged
