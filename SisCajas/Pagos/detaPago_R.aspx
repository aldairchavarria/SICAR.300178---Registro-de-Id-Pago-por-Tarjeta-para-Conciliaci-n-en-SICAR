<%@ Page Language="vb" AspCompat="true" AutoEventWireup="false" Codebehind="detaPago_R.aspx.vb" Inherits="SisCajas.detaPago_R" %>
...
<!--
	...
	function f_datos_POS()
	{
		...
		for (var i=1; i<=1; i ++)
		{
			...
			if (document.getElementById('HidFila' + i).value.length >0){
				...
				eval("document.getElementById('"+"LnkPos" + i +"').onclick = function(){blnClosingMod = false; f_EnvioPOS(" + i + ",'Imprimir POS');}");
                                //PROY-31949 				
	...
	function f_activar_fila(intFila,bolEnable)
	{
		...
		document.getElementById("icoTranPos" + intFila).alt = "Envio POS";
                ...
                //PROY-31949 
		//document.getElementById("LnkPos" + intFila).href="javascript:f_EnvioPOS(" + intFila + ",'Envio POS')";
		eval("document.getElementById('"+"LnkPos" + intFila +"').onclick = function(){blnClosingMod = false; f_EnvioPOS(" + intFila + ",'Envio POS');}");
		//PROY-31949 
	...
	function SuccessMasterCard(objResponse,NameDoc)
	{
		...
		try{
			...
			RSExecute(serverURL,"ActualizarTransaction",varTramaUpdate,
			objEntityPOS.TrnsnId,CallBack_ActTransMCD,GuardarTransactionError,"X");
			...
			if(varEstTran == '4' && varCodOpe == '01' &&  varTipoTrans == '1')
			{
				...
				//ACEPTADO VENTA
				document.getElementById("lblEnvioPos").innerHTML  = "";
				//document.getElementById(varNameLinkPOS).href = "javascript:f_EnvioPOS(" + varIntFila + ",'Imprimir POS')"; //Proy-31949
				eval("document.getElementById('"+ varNameLinkPOS +"').onclick = function(){blnClosingMod = false; f_EnvioPOS(" + varIntFila + ",'Imprimir POS');}");//Proy-31949
				document.getElementById(varNameImgPOS).src = "../images/print-icon.png";
				document.getElementById(varNameImgDelPOS).src = "../images/delete-icon.png";
				document.getElementById(varNameImgPOS).alt="Imprimir";
			}			
			...
			if (varCodOpe == '04' && (varEstTran == '3' || varEstTran == '5')){
				...
				document.getElementById("icoTranPos" + varIntFila).src = "../images/send-icon.png";
				document.getElementById("icoTranPos" + varIntFila).alt = "Envio POS";
				//document.getElementById("LnkPos" + varIntFila).href = "javascript:f_EnvioPOS(" + varIntFila + ",'Envio POS')";//Proy-31949
				eval("document.getElementById('"+ "LnkPos" + varIntFila +"').onclick = function(){blnClosingMod = false; f_EnvioPOS(" + varIntFila + ",'Envio POS');}");//Proy-31949
				document.getElementById("HidFila" + varIntFila).value = '';
				varNroTarjeta = '';
				//CNH
				document.getElementById("txtDoc" + varIntFila).disabled = true;				
	...
	function f_Recalcular(index){
		...
		suma = Math.round(suma*100)/100;
		if (suma > document.frmPrincipal.txtNeto.value){
...
//-->
	...
	<body onload="f_datos_POS();" leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
				...
				<tr>
					...
					<td vAlign="top" width="810">
										...
										<tr style="DISPLAY: none">
											...
											<td width="98%">
												<table class="Arial12B" cellSpacing="2" cellPadding="0" width="80%" align="center" border="0">
													<tr id="RefProp" style="DISPLAY: none" runat="server">
														<td>&nbsp;&nbsp;&nbsp;Nro. Referencia Propuesto :</td>
														<td><asp:textbox id="txtCorrelativo" runat="server" CssClass="clsInputDisable" Width="147px" ReadOnly="True"></asp:textbox></td>
													</tr>
													<tr id="RefImp" style="DISPLAY: none" runat="server">
														<td>&nbsp;&nbsp;&nbsp;Nro. Referencia a Imprimir:</td>
														<td><asp:textbox id="txtCompleto" runat="server" CssClass="clsInputDisable" Width="147px" ReadOnly="True"></asp:textbox></td>
													</tr>
													<tr style="DISPLAY: none">
														<td>&nbsp;&nbsp;&nbsp;Nro. Referencia :</td>
														<td><asp:textbox id="txtNumSunat" runat="server" CssClass="clsInputEnable" Width="147px" MaxLength="7"></asp:textbox></td>
													</tr>
												</table>
											</td>
						...
						<div id="divPagos" runat="server">
							...
							<table borderColor="#336699" cellSpacing="0" cellPadding="0" width="810" align="center"
								border="1" name="Contenedor">
								<tr>
									<td align="center">
										<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
												...
												<td vAlign="middle" width="100%">
													<table class="Arial12B" cellSpacing="2" cellPadding="0" width="90%" align="center" border="0">
														...
														<tr>
															...
															<td class="Arial12b" width="488" colSpan="4"><asp:textbox id="txtNomCliente" tabIndex="3" runat="server" CssClass="clsInputDisable" Width="266px"
																	ReadOnly="True"></asp:textbox></td>
														</tr>
														<tr>
															<td width="25" height="18">&nbsp;</td>
															<td class="Arial12b" width="172" height="18">&nbsp;&nbsp;&nbsp;Total Factura :</td>
															<td class="Arial12b" width="488" height="18"><asp:textbox id="txtNeto" tabIndex="3" runat="server" CssClass="clsInputDisable" Width="147px"
																	ReadOnly="True" MaxLength="30"></asp:textbox></td>
															<td class="Arial12b" width="172">&nbsp;&nbsp;Tipo Cambio:</td>
															<td class="Arial12b"></td>
															<td height="18"><asp:textbox id="txtTipoCambio" tabIndex="5" runat="server" CssClass="clsInputDisable" Width="147px"
																	ReadOnly="True" MaxLength="30"></asp:textbox></td>
														<tr>
															<td width="25">&nbsp;</td>
															<td class="Arial12b" width="172">&nbsp;&nbsp;&nbsp;Cuota Inicial:</td>
															<td class="Arial12b"><asp:textbox id="txtCuotaIni" tabIndex="4" runat="server" CssClass="clsInputDisable" Width="147px"
																	ReadOnly="True" MaxLength="30"></asp:textbox></td>
															<td class="Arial12b" width="172">&nbsp;&nbsp;Pendiente de Pago:</td>
															<td class="Arial12b"></td>
															<td height="18"><asp:textbox id="txtSaldo" tabIndex="5" runat="server" CssClass="clsInputDisable" Width="147px"
																	ReadOnly="True" MaxLength="30"></asp:textbox></td>
														</tr>
														<TR>
															<TD width="25"></TD>
															<TD class="Arial12b" width="172">&nbsp;&nbsp;&nbsp;Imprimir Documento ?</TD>
															<TD class="Arial12b"><asp:checkbox id="chkImprimir" runat="server" Checked="True"></asp:checkbox></TD>
															<TD class="Arial12b" width="172">&nbsp; Número de Operación</TD>
															<TD class="Arial12b"></TD>
															<TD height="18"><asp:textbox id="txtNotaCred" runat="server" CssClass="clsInputEnable" Width="147px" MaxLength="16"
																		...
																		<td>
																			<table borderColor="#ffffff" cellSpacing="1" cellPadding="1" width="100%" border="1">
																				<tr class="Arial12B" height="21">
																					<td borderColor="#999999" align="center" width="6%" height="22">&nbsp;</td>
																					<td borderColor="#999999" align="center" width="28%" height="22">Forma de Pago</td>
																					<td borderColor="#999999" align="center" width="31%" height="22">Nro. 
																						Tarjeta/Documento</td>
																					<td borderColor="#999999" align="center" width="35%" height="22">Monto a Pagar</td>
																				</tr>
																				<tr class="Arial12B" height="21">
																					<td align="center" width="6%" bgColor="#dddee2" height="22">
																						<!--PROY-27440 INI--><A id="IdLink1"  onclick="blnClosingMod = false; f_Borrar(document.frmPrincipal.cboTipDocumento1,document.frmPrincipal.txtDoc1,document.frmPrincipal.txtMonto1);"><IMG id="ImgEliminar1" style="CURSOR: hand" alt="Eliminar" src="../images/botones/ico_eliminar.gif"
																								border="0" name="icoeliminar"></A></td>
																					<!--PROY-27440 FIN-->
																					<td align="center" width="28%" bgColor="#dddee2" height="22">
																						<!--PROY-27440 INI--><asp:dropdownlist id="cboTipDocumento1" tabIndex="6" runat="server" CssClass="clsSelectEnable" onchange="f_bloqueo_fila(this,1);"
																							AutoPostBack="True"></asp:dropdownlist></td>
																					<!--PROY-27440 FIN-->
																					<td align="center" width="31%" bgColor="#dddee2" height="22"><asp:textbox id="txtDoc1" tabIndex="7" runat="server" Width="147px" CssClass="clsInputEnable"
																							MaxLength="20"></asp:textbox></td>
																					<td align="center" width="35%" bgColor="#dddee2" height="22"><asp:textbox id="txtMonto1" tabIndex="8" runat="server" Width="147px" CssClass="clsInputEnable"></asp:textbox>
																						<!--PROY-27440 INI--><A id="LnkPos1" style="VISIBILITY: hidden" onclick="blnClosingMod = false;f_EnvioPOS(1,'Envio POS');"
																							runat="server"><IMG id="icoTranPos1" style="CURSOR: hand" alt="Envio POS" src="../images/send-icon.png"
																								border="0" runat="server"> </A><A id="LnkDelPos1" style="VISIBILITY: hidden" onclick="blnClosingMod = false;f_EnvioPOS(1,'Eliminar POS');">
																							<IMG id="icoDelPos1" style="CURSOR: hand" alt="Eliminar POS" src="../images/delete-icon.png"
																								border="0"> </A><input id="HidTipPOS1" type="hidden" name="HidTipPOS1" runat="server">
																						<!--PROY-27440 FIN--></td>
																				</tr>
																				<tr class="Arial12B" style="DISPLAY: none" height="21">
																					<td align="center" width="6%" bgColor="#e9ebee" height="22"><A href="javascript:f_Borrar(document.frmPrincipal.cboTipDocumento2,document.frmPrincipal.txtDoc2,document.frmPrincipal.txtMonto2);"><IMG style="CURSOR: hand" alt="Eliminar" src="../images/botones/ico_eliminar.gif" border="0"
																								name="icoeliminar"></A></td>
																					<td align="center" width="28%" bgColor="#e9ebee" height="22"><asp:dropdownlist id="cboTipDocumento2" tabIndex="9" runat="server" CssClass="clsSelectEnable" AutoPostBack="True"></asp:dropdownlist></td>
																					<td align="center" width="31%" bgColor="#e9ebee" height="22"><asp:textbox id="txtDoc2" MaxLength="20" tabIndex="10" runat="server" CssClass="clsInputEnable"
																							Width="147px"></asp:textbox></td>
																					<td align="center" width="35%" bgColor="#e9ebee" height="22"><asp:textbox id="txtMonto2" tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
																				</tr>
																				<tr class="Arial12B" style="DISPLAY: none" height="21">
																					<td align="center" width="6%" bgColor="#dddee2" height="22"><A href="javascript:f_Borrar(document.frmPrincipal.cboTipDocumento3,document.frmPrincipal.txtDoc3,document.frmPrincipal.txtMonto3);"><IMG style="CURSOR: hand" alt="Eliminar" src="../images/botones/ico_eliminar.gif" border="0"
																								name="icoeliminar"></A></td>
																					<td align="center" width="28%" bgColor="#dddee2" height="22"><asp:dropdownlist id="cboTipDocumento3" tabIndex="12" runat="server" CssClass="clsSelectEnable" AutoPostBack="True"></asp:dropdownlist></td>
																					<td align="center" width="31%" bgColor="#dddee2" height="22"><asp:textbox id="txtDoc3" MaxLength="20" tabIndex="13" runat="server" CssClass="clsInputEnable"
																							Width="147px"></asp:textbox></td>
																					<td align="center" width="35%" bgColor="#dddee2" height="22"><asp:textbox id="txtMonto3" tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
																				</tr>
																				<tr class="Arial12B" style="DISPLAY: none" height="21">
																					<td align="center" width="6%" bgColor="#e9ebee" height="22"><A href="javascript:f_Borrar(document.frmPrincipal.cboTipDocumento4,document.frmPrincipal.txtDoc4,document.frmPrincipal.txtMonto4);"><IMG style="CURSOR: hand" alt="Eliminar" src="../images/botones/ico_eliminar.gif" border="0"
																								name="icoeliminar"></A></td>
																					<td align="center" width="28%" bgColor="#e9ebee" height="22"><asp:dropdownlist id="cboTipDocumento4" tabIndex="15" runat="server" CssClass="clsSelectEnable" AutoPostBack="True"></asp:dropdownlist></td>
																					<td align="center" width="31%" bgColor="#e9ebee" height="22"><asp:textbox id="txtDoc4" MaxLength="20" tabIndex="16" runat="server" CssClass="clsInputEnable"
																							Width="147px"></asp:textbox></td>
																					<td align="center" width="35%" bgColor="#e9ebee" height="22"><asp:textbox id="txtMonto4" tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
																				</tr>
																				<tr class="Arial12B" style="DISPLAY: none" height="21">
																					<td align="center" width="6%" bgColor="#dddee2" height="22"><A href="javascript:f_Borrar(document.frmPrincipal.cboTipDocumento5,document.frmPrincipal.txtDoc5,document.frmPrincipal.txtMonto5);"><IMG style="CURSOR: hand" alt="Eliminar" src="../images/botones/ico_eliminar.gif" border="0"
																								name="icoeliminar"></A></td>
																					<td align="center" width="28%" bgColor="#dddee2" height="22"><asp:dropdownlist id="cboTipDocumento5" tabIndex="18" runat="server" CssClass="clsSelectEnable" AutoPostBack="True"></asp:dropdownlist></td>
																					<td align="center" width="31%" bgColor="#dddee2" height="22"><asp:textbox id="txtDoc5" MaxLength="20" tabIndex="19" runat="server" CssClass="clsInputEnable"
																							Width="147px"></asp:textbox></td>
																					<td align="center" width="35%" bgColor="#dddee2" height="22"><asp:textbox id="txtMonto5" tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
																				</tr>
																			</table>
																		</td>
																	</tr>
									...
									<td>
										<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
											<tr>
												<td vAlign="top" width="10"></td>
												<td vAlign="middle" width="100%">
													<table class="Arial12B" cellSpacing="2" cellPadding="0" width="95%" align="center" border="0">
														<tr>
														...
														<tr>
															...
															<td><asp:label id="lblTipDoc" Visible="False" Runat="server" text="Tipo Doc:"></asp:label>Documento:</td>
															<td><asp:dropdownlist id="ddlTipDoc" tabIndex="6" runat="server" CssClass="clsSelectEnable" Visible="false">
																...
																</asp:dropdownlist><input id="txtFile" type="file" size="34" name="txtFile" runat="server">&nbsp;<asp:button id="btnCargarDocumento" runat="server" CssClass="BotonOptm" Width="42px" Text="Cargar"></asp:button>
															</td>
														</tr>
														<tr>
															<td width="200"></td>
															<td></td>
															<td width="110">
															<td><asp:label id="lblArchivoDOL" style="DISPLAY: none" Runat="server" text="Ver"></asp:label><asp:imagebutton id="imgElimDoc" Visible="False" Runat="server" ImageUrl="../../images/iconos/ico_eliminar.gif"
																	AlternateText="Eliminar Documento DOL"></asp:imagebutton><br>
																<asp:label id="lblArchivo" style="DISPLAY: none" Runat="server" text="Ver"></asp:label></td>
														</tr>
													</table>
												</td>
											</tr>
