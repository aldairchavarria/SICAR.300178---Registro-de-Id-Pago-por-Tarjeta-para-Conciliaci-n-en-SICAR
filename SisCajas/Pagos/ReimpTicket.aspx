									...
									<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
										<tr>
											...
											<td class="TituloRConsulta" style="PADDING-TOP: 4px" vAlign="top" align="center" width="98%"
												height="32">Reimpresión de Tickets</td>
											<td vAlign="top" width="10" height="32"></td>
										</tr>
									</table>
									<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
											...
											<td style="PADDING-RIGHT: 5px; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; PADDING-TOP: 5px"
												...
												<table cellSpacing="0" cellPadding="0" width="770" border="0">
													<TR>
														...
														<TD class="Arial12b" style="WIDTH: 121px; HEIGHT: 18px">Núm.&nbsp;de&nbsp; 
															referencia:&nbsp;</TD>
...
function f_Valida()
{
  ...
  if(!ValidaAlfanumericoTicket('document.frmPrincipal.txtNumRef','El campo número de referencia no esta completo',false)) return false
