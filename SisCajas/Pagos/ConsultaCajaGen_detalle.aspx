<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConsultaCajaGen_detalle.aspx.vb" Inherits="SisCajas.ConsultaCajaGen_detalle" %>
...
<HTML>
  ...
  <body MS_POSITIONING="GridLayout">
    ...
    <form id="frmCCGDetalle" method="post" runat="server">
    <table border="0" cellSpacing="0" cellPadding="0">
					...
					<tr>
						<td>
							<TABLE style="BORDER-BOTTOM: #336699 1px solid; BORDER-LEFT: #336699 1px solid; BORDER-TOP: #336699 1px solid; BORDER-RIGHT: #336699 1px solid"
								...
								<TR>
									<TD class="TituloRConsulta" align="center">Cuadre General</TD>
								</TR>
								<TR>
									<TD>
			...
			<div id="divComandos" style="padding-top:10px;">
				<TABLE style="BORDER-BOTTOM: #336699 1px solid; BORDER-LEFT: #336699 1px solid; WIDTH: 151px; HEIGHT: 29px; BORDER-TOP: #336699 1px solid; BORDER-RIGHT: #336699 1px solid"
					id="Table2" border="0" cellSpacing="0" cellPadding="2" align="center">
					<TR>
						<TD align="center">
							<TABLE style="WIDTH: 136px; HEIGHT: 20px" id="Table4" align="center">
								<TR>
    ...
    <script language=JavaScript>
			function f_Exportar()
			{
				document.frmTmp.action = 'ConsultaCajaGen_excel.aspx';
