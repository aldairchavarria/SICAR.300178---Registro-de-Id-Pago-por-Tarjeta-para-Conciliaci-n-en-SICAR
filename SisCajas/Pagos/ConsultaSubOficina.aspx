<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConsultaSubOficina.aspx.vb" Inherits="SisCajas.ConsultaSubOficina"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>ConsultaSubOficina</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="frmCCTOficina" method="post" runat="server">
			<table border="1" cellSpacing="0" borderColor="#336699" cellPadding="4" width="375" align="center">
				<tr>
					<td align="center"><asp:label id="lblTitulo" runat="server" CssClass="TituloConsulta">Buscar Sub Oficina</asp:label></td>
				</tr>
			</table>
			<br>
							...
							<td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; PADDING-TOP: 0px"
								...
								<div style="WIDTH: 324px; HEIGHT: 114px" class="frame2">
									<asp:datagrid style="Z-INDEX: 0" id="DGLista" runat="server" CssClass="Arial11b" Width="328px"
										...
										EnableViewState="True" DataKeyField="SUOFV_ID">
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="Codigo" ItemStyle-HorizontalAlign="Center" Visible="False">
												<HeaderStyle BorderWidth="1px" BorderColor="#999999" Width="5%"></HeaderStyle>
												<ItemTemplate>
													<asp:Label ID="lblCodigo" Runat="server" Text='<%# Container.DataItem("SUOFV_ID")%>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:BoundColumn DataField="SUOFV_SUB_OFICINA" HeaderText="Sub Oficina">
