<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReimpRemesa.aspx.vb" Inherits="SisCajas.ReimpRemesa"%>
...
<HTML>
	<HEAD>
		...
		function f_Imprimir(){
			...
			objIframe.src = "FormatoRemesaReimp.aspx?strBolsa=" + document.frmPrincipal.txtBolsa.value;
		}
	...
	<body MS_POSITIONING="GridLayout">
		<form id="frmPrincipal" name="frmPrincipal" method="post" runat="server">
									...
									<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
										<tr>
											...
											<td class="TituloRConsulta" style="PADDING-TOP: 4px" vAlign="top" align="center" width="98%"
												height="32">
												Reimpresión de Envio de Remesa</td>
											<td vAlign="top" width="10" height="32"></td>
										</tr>
									</table>
									<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
								...
								<TD align="center">
									<TABLE cellSpacing="2" cellPadding="0" border="0">
										<TR>
											...
											<TD align="center" width="85"><input type="button" class="BotonOptm" id="btnImprimir" value="Imprimir" onclick="f_Valida()"
													style="WIDTH: 98px"></TD>
											<TD align="center" width="28"></TD>
										</TR>
									</TABLE>
			...
			</TD></TR></TABLE> <iframe id="IfrmImpresion" name="IfrmImpresion" style="VISIBILITY: hidden; WIDTH: 0px; HEIGHT: 0px"
				src="#"></iframe>
		</form>
