<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConsultaCajaTot_caja.aspx.vb" Inherits="SisCajas.ConsultaCajaTot_caja" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="frmCCTCaja" method="post" runat="server">
			<table width="375" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#336699">
				<tr>
					<td align="center">
						<asp:Label id="lblTitulo" runat="server" CssClass="TituloConsulta">Buscar Caja</asp:Label>
					</td>
				</tr>
			</table>
			<br>
									...
									<asp:datagrid style="Z-INDEX: 0" id="DGLista" runat="server" CssClass="Arial11b" Width="328px"
										...
										<Columns>
											<asp:TemplateColumn HeaderText="Opci&#243;n" ItemStyle-HorizontalAlign="Center">
												...
												<ItemTemplate>
													<INPUT id="rbSel" type="radio" value='<%# DataBinder.Eval(Container,"DataItem.ID_CAJA_OFICINA") %>' name="rbSel">
												</ItemTemplate>
											</asp:TemplateColumn>
											...
											<asp:BoundColumn DataField="DESCRIPCION" HeaderText="Caja">
