<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ListarCaja_excel.aspx.vb" Inherits="SisCajas.ListarCaja_excel" contentType="application/vnd.ms-excel" enableViewState="False" responseEncoding="windows-1250" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
  <head>
    <title>ListaCaja_excel</title>
  ...
  <body MS_POSITIONING="GridLayout">
    <form id="frmPrincipal" method="post" runat="server">
		...
		<tr>
			<td>
				<FONT face="Arial" size="2"><STRONG>Detalle Caja - Oficina</STRONG></FONT>
			</td>
		</tr>
		<tr>
			<td></td>
				...
				<td>
					<asp:datagrid id="dgReporte" runat="server" AutoGenerateColumns="False">
						...
						<Columns>
							...
							<asp:BoundColumn DataField="CAJA" HeaderText="Caja"></asp:BoundColumn>
