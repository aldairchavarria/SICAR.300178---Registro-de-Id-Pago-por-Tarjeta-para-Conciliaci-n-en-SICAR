Public Class ConsultaCajaTot_oficina
...
#Region "Eventos"
    ...
    Private Sub DGLista_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DGLista.PageIndexChanged
        ...
        DGLista.DataSource = Session("dgListaOficina")
        DGLista.DataBind()
        RePopulateValues()
    End Sub
    ...
    Private Sub cmdAceptar_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAceptar.ServerClick
        ...
        Try
            If Not Session("CHECKED_OFI_2") Is Nothing Then
                lstOficinas = DirectCast(Session("CHECKED_OFI_2"), ArrayList)
            ...
            If Not strOficinas.Equals(String.Empty) Then
                ...
                Session("ConCajTot_codOficina") = strOficinas.Substring(0, ilenCad - 1)
...
#Region "Metodos"
    ...
    Private Sub Buscar()
        Try
            ...
            Dim dsResult As DataSet = objclsAdmCaja.GetOficinas("I-318," + strOficina.ToUpper()) 'INICIATIVA-318

            Session("dgListaOficina") = dsResult.Tables(0)
            Me.DGLista.DataSource = Session("dgListaOficina")
    ...
    Private Sub RemenberOldValue()
        ...
        For Each fila As DataGridItem In DGLista.Items
            ...
            If Not Session("CHECKED_OFI_2") Is Nothing Then
                codigosOficinas = DirectCast(Session("CHECKED_OFI_2"), ArrayList)
            End If
            If result Then
            ...
            If (Not codigosOficinas Is Nothing) And (codigosOficinas.Count > 0) Then
                Session("CHECKED_OFI_2") = codigosOficinas
            End If
        Next
    End Sub
