<%@ Page Language="vb" AutoEventWireup="false" Codebehind="formatoRemesaReimp.aspx.vb" Inherits="SisCajas.formatoRemesaReimp"%>
			...
			<table style="WIDTH: 648px; HEIGHT: 117px">
				...
				<tr>
					<td style="WIDTH: 259px; HEIGHT: 21px"><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; FONT-FAMILY: Arial">Código 
							PDV</FONT></td>
					<td style="WIDTH: 67px; HEIGHT: 21px"><%= Session("ALMACEN")%>
					</td>
					<td style="WIDTH: 130px; HEIGHT: 21px"><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; FONT-FAMILY: Arial">Fecha 
							y Hora</FONT></td>
					<td style="HEIGHT: 21px"><asp:Label id="lblFecha" runat="server"></asp:Label></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3"><asp:Label id="lblBolsa" runat="server"></asp:Label></td>
				</tr>
				<tr>
					<td style="WIDTH: 259px"><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; FONT-FAMILY: Arial">Nombre 
							del responsable</FONT></td>
					<td colspan="3"><asp:Label id="lblNombre" runat="server"></asp:Label></td>
				</tr>
				<tr>
					<td style="WIDTH: 130px"><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; FONT-FAMILY: Arial">
							Cod.&nbsp;responsable</FONT></td>
					<td colspan="3"><asp:Label id="lblCodigo" runat="server"></asp:Label></td>
				</tr>
			</table>
			<table>
				<tr height="30">
			...
			<table style="WIDTH: 648px; HEIGHT: 117px" border="1">
				...
				<tr>
					<td style="HEIGHT: 26px"><FONT style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Importe a 
							depositar</FONT></td>
					<td style="HEIGHT: 26px" align="right"><asp:Label id="lblImpSol" runat="server"></asp:Label>&nbsp;</td>
					<td style="HEIGHT: 26px" align="right"><asp:Label id="lblImpDol" runat="server"></asp:Label>&nbsp;</td>
				</tr>
				<tr>
					<td><FONT style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Cheque(s) a depositar</FONT></td>
					<td align="right"><asp:Label id="lblChSol" runat="server"></asp:Label>&nbsp;</td>
					<td align="right"><asp:Label id="lblChDol" runat="server"></asp:Label>&nbsp;</td>
				</tr>
				<tr>
					<td><FONT style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; FONT-FAMILY: Arial">TOTAL A 
							DEPOSITAR</FONT></td>
					<td align="right"><asp:Label id="lblTSol" runat="server"></asp:Label>&nbsp;</td>
					<td align="right"><asp:Label id="lblTDol" runat="server"></asp:Label>&nbsp;</td>
				</tr>
			</table>
			<br>
			<br>
