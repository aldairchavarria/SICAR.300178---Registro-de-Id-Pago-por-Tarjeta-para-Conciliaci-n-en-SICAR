<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConsultaCajaGen_excel.aspx.vb" Inherits="SisCajas.ConsultaCajaGen_excel" contentType="application/vnd.ms-excel" enableViewState="False" responseEncoding="windows-1250" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
  <head>
    <title>ConsultaCajaGen_excel</title>
  ...
  <body MS_POSITIONING="GridLayout">
	<form id="frmPrincipal" method="post" runat="server">
		...
		<tr>
			<td>
				<FONT face="Arial" size="2"><STRONG>Cuadre General</STRONG></FONT>
			</td>
		</tr>
		<tr>
			<td></td>
