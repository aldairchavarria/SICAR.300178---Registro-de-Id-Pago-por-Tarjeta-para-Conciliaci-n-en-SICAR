<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ListarCaja_CargarDatos.aspx.vb" Inherits="SisCajas.ListarCaja_CargarDatos" %>
...
<HTML>
	<HEAD>
		...
		function f_Nuevo(){
			Direcc = "ListarCaja_Nuevo.aspx?CodCajaOfi=0"
			window.open(Direcc,"Adiciona","directories=no,menubar=no,scrollbars=no,top=200,resizable=yes,left=185,width=500,height=300");
		}
		
		function f_Actualizar(var1){
			Direcc = "ListarCaja_Nuevo.aspx?CodCajaOfi="+var1
			window.open(Direcc,"Actuali","directories=no,menubar=no,scrollbars=no,top=200,resizable=yes,left=185,width=500,height=300");
		}
		function f_Refrescar(){
			frmListarCajaOfic.refreshHandler.click();
		}
		function f_Eliminar(var1){
			var rpta = window.confirm('¿Desea eliminar el registro seleccionado?');
            if (rpta) {
				document.frmListarCajaOfic.hidIDCajaOfi.value = var1;
                frmListarCajaOfic.eliminarHandler.click();
            }
		}
	...
	<body>
		<form id="frmListarCajaOfic" method="post" runat="server">
			<input id="hidIDCajaOfi" type="hidden" name="hidIDCajaOfi" value="0">
					...
					<tr>
						<td>
							<TABLE style="BORDER-BOTTOM: #336699 1px solid; BORDER-LEFT: #336699 1px solid; BORDER-TOP: #336699 1px solid; BORDER-RIGHT: #336699 1px solid"
								...
								<TR>
									<TD class="TituloRConsulta" align="center">Detalle Caja - Oficina</TD>
								</TR>
								<TR>
									<TD>
													...
													<td style="PADDING-BOTTOM: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; PADDING-TOP: 0px"
														...
														<div style="WIDTH: 550px" class="frame2">
															<asp:datagrid style="Z-INDEX: 0" id="DGListaOfi" runat="server" CssClass="Arial12b" AutoGenerateColumns="False">
																...
																<Columns>
																	<asp:BoundColumn DataField="ID_CAJA_OFICINA" HeaderText="ID" Visible="False"></asp:BoundColumn>
																	...
																	<asp:TemplateColumn HeaderText="Opción">
																		...
																		<ItemStyle HorizontalAlign="Center"></ItemStyle>
																		<ItemTemplate>
																			<img src="../images/botones/edit.gif" style="cursor:hand" onclick="f_Actualizar('<%# DataBinder.Eval(Container,"DataItem.ID_CAJA_OFICINA")%>')" alt="Editar"> &nbsp;&nbsp;&nbsp;
																			<img src="../images/botones/ico_eliminar.gif" style="cursor:hand" onclick="f_Eliminar('<%# DataBinder.Eval(Container,"DataItem.ID_CAJA_OFICINA")%>')" alt="Eliminar" >
																		</ItemTemplate>
																	</asp:TemplateColumn>
																</Columns>
															</asp:datagrid>
										...
										<TD align="center">
											<TABLE id="Table4" align="center">
												<TR>
													...
													<TD style="WIDTH: 96px">
														<asp:button id="btnCancelar" runat="server" CssClass="BotonOptm" Width="100px" Text="Cancelar"></asp:button>
		...
		<script language=JavaScript>
			function f_Exportar()
			{
				document.frmTmp.action = 'ListarCaja_excel.aspx';
