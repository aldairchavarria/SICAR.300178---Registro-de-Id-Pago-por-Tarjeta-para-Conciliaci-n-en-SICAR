...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents btnBuscar As System.Web.UI.WebControls.Button 'INI-936 - JH
...
#Region "Eventos"
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If (Session("USUARIO") Is Nothing) Then
            ...
            Exit Sub
        Else
            'INI-936 - JH - Atributos agregado evento para el boton
    ...
    Private Sub loadDataHandler_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles loadDataHandler.Click
        Try
            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   Inicio GEN - loadDataHandler_Click ")
        ...
        Finally
            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   Fin GEN - loadDataHandler_Click ")
        End Try
    End Sub
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        Try
            ...
            Dim strUrl As String = "ConsultaCajaGen_cargardatos.aspx?"
            Dim strMsjErr As String = String.Empty

            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   Inicio btnBuscar_Click ") 'INI-936 - JH
            ...
            strUrl = strUrl & "fi=" & strFechaIni & "&ff=" & strFechaFin & "&cc=" & strCodCajero & "&st=" & strEstado 'INI-936-JH
        ...
        Catch ex As Exception
            Response.Write("<script language=jscript> alert('" + ex.Message + "'); </script>")
            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   error btnBuscar_Click: " & ex.Message) 'INI-936 - JH
        Finally
            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   FIN btnBuscar_Click: ") 'INI-936 - JH
        End Try
    End Sub
