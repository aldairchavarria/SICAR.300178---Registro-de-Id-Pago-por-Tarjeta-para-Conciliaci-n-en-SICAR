Public Class ListarImpresora_excel
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Try
                If Not Session("listaImpresoraOfi") Is Nothing Then
                    dgReporte.DataSource = CType(Session("listaImpresoraOfi"), DataTable)
                Else
                    dtDatos = CType(Session("listaImpresoraOfi"), DataTable)
