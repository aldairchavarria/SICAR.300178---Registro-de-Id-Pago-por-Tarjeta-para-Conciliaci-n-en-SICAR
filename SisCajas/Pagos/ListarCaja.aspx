<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ListarCaja.aspx.vb" Inherits="SisCajas.ListarCaja" %>
							...
							<tr>
								<td style="PADDING-BOTTOM: 5px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; PADDING-TOP: 5px"
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td class="TituloRConsulta" align="center" height="30">Consulta Caja - Oficina</td>
										</tr>
									</table>
						...
						<table class="tabla_borde" cellSpacing="0" cellPadding="4" width="360">
							<tr>
								<td align="center">
									...
									<input class="BotonOptm" style="WIDTH: 100px" onclick="f_LimpiaControl();" type="button" value="Limpiar" name="btnLimpiar">
