<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ConsultaCajaInd_oficina.aspx.vb" Inherits="SisCajas.ConsultaCajaInd_oficina" %>
...
<html>
  <head>
		...
		function f_buscar(){
			if(event.keyCode == 13 ){
				frmCCTOficinaB.cmdBuscar.click();
			}
		}
  ...
  <body MS_POSITIONING="GridLayout">
    <form id="frmCCTOficinaB" method="post" runat="server">
		<table border="1" cellSpacing="0" borderColor="#336699" cellPadding="4" width="375" align="center">
			<tr>
				<td align="center"><asp:label id="lblTitulo" runat="server" CssClass="TituloConsulta">Buscar Oficina</asp:label></td>
			</tr>
		</table>
		<br>
							...
							<div style="WIDTH: 324px; HEIGHT: 114px" class="frame2">
								<asp:datagrid style="Z-INDEX: 0" id="DGLista" runat="server" CssClass="Arial11b" Width="328px"
									...
									<Columns>
										...
										<asp:BoundColumn DataField="DESCRIPCION" HeaderText="Oficina">
