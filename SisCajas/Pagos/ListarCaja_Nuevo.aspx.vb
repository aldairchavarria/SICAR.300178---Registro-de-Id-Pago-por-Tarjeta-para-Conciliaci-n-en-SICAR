...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txtNroCaja As System.Web.UI.HtmlControls.HtmlInputText
    ...
    Protected WithEvents lblTitNuevoCaja As System.Web.UI.WebControls.Label
...
#Region "Evento"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Not Page.IsPostBack Then
                ...
                If Not Request.QueryString("CodCajaOfi") Is Nothing Then
                    If CInt(Request.QueryString("CodCajaOfi")) = 0 Then 'Nuevo
                        txtDescripcion.Value = String.Empty
                        txtNroCaja.Value = String.Empty
                    Else 'Editar
                        lblTitNuevoCaja.Text = "Modificar Caja"
                        CargarDatos(CLng(Request.QueryString("CodCajaOfi")))
                    End If
                End If
            End If
        End If
    ...
    Private Sub cmdGrabar_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGrabar.ServerClick
        ...
        Try
            ...
            Dim lCodCajaOfic As Long = CLng(Request.QueryString("CodCajaOfi"))
            ...
            If Trim(txtNroCaja.Value) = "" Then
                Response.Write("<script>alert('Ingrese el Nro de Caja');</script>")
                Exit Sub
            End If
            ...
            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   In NroCaja: " & CStr(txtNroCaja.Value))
            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   In strEstado: " & strEstado)
            objFileLog.Log_WriteLog(pathFile, strArchivo, strIdentifyLog & "- " & "   In COdigo: " & lCodCajaOfic)
            If lCodCajaOfic = 0 Then ' nuevo
                strMsjErr = objclsAdmCaja.SetCajaOficina(strOficina, CStr(txtDescripcion.Value), CStr(txtNroCaja.Value), strEstado)
                bEditar = False
            Else 'editar
                strMsjErr = objclsAdmCaja.ActualizarCajaOficina(lCodCajaOfic, strOficina, CStr(txtDescripcion.Value), CStr(txtNroCaja.Value), strEstado)
                bEditar = True
            End If
...
#Region "Metodos"
    ...
    Private Sub CargarDatos(ByVal IdCajaOficina As Long)
        objclsAdmCaja = New COM_SIC_Adm_Cajas.clsAdmCajas
        Dim dsDatosCaja As DataSet
        dsDatosCaja = objclsAdmCaja.GetCajaOficina(String.Empty, optTODOS, IdCajaOficina)
        ...
        If Not dsDatosCaja Is Nothing Then
            ...
            If Not drDatosCaja Is Nothing Then
                ...
                If Not IsDBNull(drDatosCaja("CAJA")) Then
                    txtNroCaja.Value = drDatosCaja("CAJA")
                End If
                ...
                If Not IsDBNull(drDatosCaja("ESTADO")) Then
