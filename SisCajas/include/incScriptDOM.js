...
function HM_f_MakeItemElement(menucount) {
	...
	//RGDSH
	//ItemElement.innerText = ('<iframe img src=' + ItemElement.dispText.substring(9) + 'scrolling="no" frameborder="0" height=10></iframe>' + ItemElement.innerHTML);
	//ItemElement.innerHTML = ('<iframe ' +ItemElement.dispText.substring(5) + ' scrolling="no" frameborder="0"></iframe>' + ItemElement.innerHTML);
	//ItemElement.innerHTML =  ItemElement.innerHTML + ('<iframe src="about:blank" scrolling="no" frameborder="0"></iframe>');
	//ItemElement.style.zIndex="99";
	//RGDSH
...
function HM_f_LinkIt() {
    ...
    if (this.linkText.indexOf("javascript")!=-1){
		eval(this.linkText);
          ...
          window.frames("dataframe").location.href = this.linkText;
