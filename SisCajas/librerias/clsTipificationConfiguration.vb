...
Public Class clsTipificationConfiguration
    ...
    Private _KeyClaseFidelizacionIFI As String
    Private _keySubClaseFidelizacionIFI As String
    ...
    Public Property KeyClaseFidelizacionIFI() As String
        Get
            Return _KeyClaseFidelizacionIFI
        End Get
        Set(ByVal Value As String)
            _KeyClaseFidelizacionIFI = Value
        End Set
    End Property

    Public Property KeySubClaseFidelizacionIFI() As String
        Get
            Return _keySubClaseFidelizacionIFI
        End Get
        Set(ByVal Value As String)
            _keySubClaseFidelizacionIFI = Value
        End Set
    End Property
