<%@ Page Language="vb" aspcompat=true AutoEventWireup="false" Codebehind="rep_VentaDetallada.aspx.vb" Inherits="SisCajas.rep_VentaDetallada"%>
<HTML>
	<HEAD>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="Arial10B">
													<tr>
														...
														<td width="98%" height="32" align="center" class="TituloRConsulta">Cuadre de Caja - 
															Detalle de Ventas Facturadas</td>
...
if (esIExplorer) {
	...
	function f_Exportar()
	{
		...
		document.frmTmp.action = 'rep_ventaDetalladaExcel.aspx?&strFecha=<%=strFecha%>';
