<%@ Page Language="vb" aspcompat="true" AutoEventWireup="false" Codebehind="rep_OperaDetallada.aspx.vb" Inherits="SisCajas.rep_OperaDetallada" %>
<HTML>
	<HEAD>
...
//-->
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<form id="frmPrincipal" name="frmPrincipal" method="post" target="_blank">
			<input id=strFecha type=hidden value="<%=strFecha%>" 
			...
			<table cellSpacing="0" cellPadding="0" width="975" border="0">
				<tr>
					...
					<td vAlign="top" width="820">
												...
												<table class="Arial10B" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
													<tr>
														...
														<td class="TituloRConsulta" align="center" width="98%" height="32">Cuadre de Caja - 
															Detalle de Operaciones Procesadas</td>
																	...
																	<td>
																		<table cellSpacing="2" cellPadding="0" width="100%" border="0">
																			<tr>
																				...
																				<td class="Arial12b" width="170"><input 
                                class=clsInputDisable id=txtNombres4 type=text 
																...
																<tr>
																	<td height="18">
																		<div class="frame2" style="BORDER-RIGHT: 1px; BORDER-TOP: 1px; OVERFLOW-Y: scroll; OVERFLOW-X: scroll; BORDER-LEFT: 1px; WIDTH: 770px; BORDER-BOTTOM: 1px; HEIGHT: 300px; TEXT-ALIGN: center">
																			...
																			<asp:datagrid id="DgOpera" Width="100%" Height="30px" CellSpacing="1" AutoGenerateColumns="False"
						...
						<iframe id="ifraExcel" style="DISPLAY: none"></iframe></td>
				</tr>
			</table>
...
if (esIExplorer) {
	...
	function f_Exportar()
	{
		...
		document.all.ifraExcel.src="rep_OperaDetExcel.aspx?pfecha="+frmPrincipal.strFecha.value;
