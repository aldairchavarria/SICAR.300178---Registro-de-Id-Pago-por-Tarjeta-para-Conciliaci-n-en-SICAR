<%@ Page Language="vb" AutoEventWireup="false" Codepage="1252" Codebehind="rep_OperaDetIndExcel.aspx.vb" Inherits="SisCajas.rep_OperaDetIndExcel" %>
	...
	<body leftMargin="0" topMargin="0" marginwidth="0" marginheight="0">
		<form id="frmPrincipal" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="1000" border="0">
				<tr>
					<td colspan="4">Cuadre de Caja - Detalle de Operaciones Procesadas - Individual</td>
				<tr>
				</tr>
			</table>
			<table>
						...
						<TR>
							<td>
								<asp:datagrid id="DgOpera" runat="server" BorderColor="Black" CssClass="Arial11B" AutoGenerateColumns="False"
									CellSpacing="1" Height="30px" Width="100%" BorderWidth="1px">
			...
			</TABLE> <INPUT type="hidden" id="txtUsuario" runat="server">
		</form>
	</body>
</HTML>
