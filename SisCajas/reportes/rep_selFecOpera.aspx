<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_selFecOpera.aspx.vb" Inherits="SisCajas.rep_selFecOpera" %>
<HTML>
	<HEAD>
...
function f_Aprobar(){
	var chk = f_Validar();
		if(chk == true){			
		    ...
		    window.location='rep_OperaDetallada.aspx?pfecha='+ frmPrincipal.txtFecha.value.substr(6,4)+frmPrincipal.txtFecha.value.substr(3,2)+frmPrincipal.txtFecha.value.substr(0,2);
		}
};
