<%@ Page Language="vb" aspcompat=true AutoEventWireup="false" Codebehind="rep_VentaInd.aspx.vb" Inherits="SisCajas.rep_VentaInd"%>
<HTML>
	<HEAD>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="Arial10B">
													<tr>
														...
														<td width="98%" height="32" align="center" class="TituloRConsulta">Cuadre de Caja - 
															Ventas Facturadas Individual</td>
...
if (esIExplorer) {
	...
	function f_Exportar()
	{
		//document.frmTmp.action = '<%=strRuta%>/reportes/toExcel.aspx?tipo=1&Individual=1&strFecha=<%=strFecha%>';
		document.frmTmp.action = 'rep_VentaDocExcel.aspx?Individual=1&strFecha=<%=strFecha%>';
