<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_DiarioGEN.aspx.vb" Inherits="SisCajas.rep_DiarioGEN"%>
<HTML>
	<HEAD>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="Arial10B">
													<tr>
														...
														<td width="98%" height="32" align="center" class="TituloRConsulta">
															Reporte de Diario Electronico por Fechas
														</td>
																		...
																		<table border="0" width="80%" cellspacing="2" cellpadding="0">
																			<tr>
																				...
																				<td class="Arial12b" width="200">
																					<input name="txtFechaIni" type="text" class="clsInputEnable" id="txtFechaIni" tabindex="34"
																						size="10" maxlength="10" value='<%=Format(Day(Now), "00") & "/" & Format(Month(Now), "00") & "/" & Format(Year(Now), "0000")%>'> <a href="javascript:show_calendar('frmPrincipal.txtFechaIni');" onMouseOut="window.status='';return true;"
																				...
																				<td class="Arial12b" width="200">
																					<input name="txtFechaFin" type="text" class="clsInputEnable" id="txtFechaFin" tabindex="34"
																						size="10" maxlength="10" value='<%=Format(Day(Now), "00") & "/" & Format(Month(Now), "00") & "/" & Format(Year(Now), "0000")%>'> <a href="javascript:show_calendar('frmPrincipal.txtFechaFin');" onMouseOut="window.status='';return true;"
																						onMouseOver="window.status='Date Picker';return true;"><img border="0" src="../../images/botones/btn_Calendario.gif"></a>
																				</td>
																			</tr>
																		</table>
...
function f_Reporte()
{
   ...
   {  
   if (FechaMenor('document.frmPrincipal.txtFechaFin','document.frmPrincipal.txtFechaIni','Fecha Final','Fecha Inicial'))
   {		
   		strFechaIni = document.frmPrincipal.txtFechaIni.value 
		strFechaFin = document.frmPrincipal.txtFechaFin.value 
		   
		document.frmExp.action="rep_DiarioGENExcel.aspx?strFecIni=" + strFechaIni + "&strFecFin=" + strFechaFin 
