<%@ Page Language="vb" AutoEventWireup="false" Codebehind="repElimBuzon.aspx.vb" Inherits="SisCajas.repElimBuzon"%>
<HTML>
	<HEAD>
												...
												<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="Arial10B">
													<tr>
														...
														<td width="98%" height="32" align="center" class="TituloRConsulta">
															Reporte de Eliminación de Envíos a Caja Buzón
														</td>
																			...
																			<tr>
																				...
																				<td class="Arial12b" width="200">
																					<input name="txtFechaIni" type="text" class="clsInputEnable" id="txtFechaIni" tabindex="34"
																						size="10" maxlength="10" value='<%=Now.Date.ToString("d")%>'> <a href="javascript:show_calendar('frmPrincipal.txtFechaIni');" onMouseOut="window.status='';return true;"
																				...
																				<td class="Arial12b" width="200">
																					<input name="txtFechaFin" type="text" class="clsInputEnable" id="txtFechaFin" tabindex="34"
																						size="10" maxlength="10" value='<%=Now.Date.ToString("d")%>'> <a href="javascript:show_calendar('frmPrincipal.txtFechaFin');" onMouseOut="window.status='';return true;"
																						onMouseOver="window.status='Date Picker';return true;"><img border="0" src="../../images/botones/btn_Calendario.gif"></a>
																				</td>
																			</tr>
																		</table>
...
function f_Reporte()
{
   ...
   {  
		...
		document.frmExp.action="repElimBuzonExcel.aspx?strFechaIni=" + strFechaIni + "&strFechaFin=" + strFechaFin 
