<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_VentFact.aspx.vb" Inherits="SisCajas.rep_VentFact"%>
<HTML>
	<HEAD>
...
function f_Aprobar(){
	var chk = f_Validar();
		if(chk == true){
			document.frmPrincipal.codOperacion.value = "02";
											...
											<td align="center">
												<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="Arial10B">
													<tr>
														...
														<td width="98%" height="32" align="center" class="TituloRConsulta">Ventas 
															Facturadas PDV</td>
