<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_selFecDiario.aspx.vb" Inherits="SisCajas.rep_selFecDiario" %>
<HTML>
	<HEAD>
...
function f_Aprobar(){
	var chk = f_Validar();
		if(chk == true){			
			window.location='rep_Diario.aspx?pfecha='+ frmPrincipal.txtFecha.value.substr(6,4)+frmPrincipal.txtFecha.value.substr(3,2)+frmPrincipal.txtFecha.value.substr(0,2);
		}
};
											...
											<td align="center">
												<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="Arial10B">
													<tr>
														...
														<td width="98%" height="32" align="center" class="TituloRConsulta">Diario 
															Electrónico PDV</td>
