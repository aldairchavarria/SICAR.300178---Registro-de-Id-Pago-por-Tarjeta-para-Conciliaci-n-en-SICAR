<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_selFecDiaInd.aspx.vb" Inherits="SisCajas.rep_selFecDiaInd" %>
<HTML>
	<HEAD>
...
function f_Aprobar(){
	var chk = f_Validar();
		if(chk == true){			
			window.location='rep_DiarioDetInd.aspx?pfecha='+ frmPrincipal.txtFecha.value.substr(6,4)+frmPrincipal.txtFecha.value.substr(3,2)+frmPrincipal.txtFecha.value.substr(0,2)+"&pusuario="+frmPrincipal.txtUsuario.value;
		}
};
...
//-->
	...
	<body topmargin="0" leftmargin="0" onClick="<%=strSiteOcultarCapas%>">
		<form name="frmPrincipal" id="frmPrincipal" method="post" runat="server">
																...
																<tr>
																	<td>
																		<table border="0" width="80%" cellspacing="2" cellpadding="0">
																			<tr>
																				<td width="250">&nbsp;</td>
																				<td class="Arial12b" width="200">&nbsp;&nbsp;&nbsp;Fecha Diario:</td>
			...
			<INPUT type="hidden" id="txtUsuario" runat="server" NAME="txtUsuario">
		</form>
