<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_selFecDetFact.aspx.vb" Inherits="SisCajas.rep_selFecDetFact"%>
<HTML>
	<HEAD>
...
function f_Aprobar(){
	var chk = f_Validar();
		if(chk == true){
			document.frmPrincipal.codOperacion.value = "03";
