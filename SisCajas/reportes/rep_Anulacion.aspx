<%@ Page Language="vb" aspcompat="true" AutoEventWireup="false" Codebehind="rep_Anulacion.aspx.vb" Inherits="SisCajas.rep_Anulacion" %>
<HTML>
	<HEAD>
																...
																<tr>
																	<td height="4">&nbsp;
																		<table cellSpacing="2" cellPadding="0" width="100%" border="0">
																			<tr>
																				<td width="15">&nbsp;</td>
																				<td class="Arial12b" width="65">&nbsp;&nbsp;&nbsp;Cajero:</td>
																				<td class="Arial12b" width="170"><asp:dropdownlist id="CboCajero" runat="server" Width="224px" CssClass="clsSelectEnable"></asp:dropdownlist></td>
																				<td width="30">&nbsp;</td>
																			</tr>
																		</table>
																	</td>
																...
																<tr>
																	<td>
																		<table cellSpacing="2" cellPadding="0" width="100%" border="0">
																			<tr>
																				<td width="26">&nbsp;</td>
																				<td class="Arial12b" width="116">&nbsp;&nbsp;&nbsp;Fecha :</td>
																				<td class="Arial12b" width="170"><input class="clsInputEnable" id="txtFecha" tabIndex="34" type="text" maxLength="10" size="10"
													...
													<tr>
														<td width="98%">
															<table cellSpacing="0" cellPadding="0" width="770" border="0">
																...
																<tr>
																	<td height="18">
																		<div class="frame2" style="BORDER-RIGHT: 1px; BORDER-TOP: 1px; OVERFLOW-Y: scroll; Z-INDEX: 1; OVERFLOW-X: scroll; BORDER-LEFT: 1px; WIDTH: 770px; BORDER-BOTTOM: 1px; POSITION: relative; HEIGHT: 260px; TEXT-ALIGN: center">
																			<table class="tabla_interna_borde1" cellSpacing="1" cellPadding="1" width="100%">
																				<%=auxprint%>
																			</table>
																			<asp:datagrid id="DgAnulacion" runat="server" Width="738px" CssClass="Arial11B" CellSpacing="1"
																				...
																				<Columns>
																					...
																					<asp:BoundColumn HeaderText="Nro Tarjeta/Documento">
																						<HeaderStyle BorderWidth="1px" BorderColor="#999999"></HeaderStyle>
																					</asp:BoundColumn>
...
if (esIExplorer) {
	...
	function f_Exportar()
	{
		//document.frmTmp.action = './toExcel.aspx?tipo=4&Individual=0&strFecha=<%=strFecha%>';
		//document.frmTmp.action = 
		//document.frmTmp.submit();
		var strFecha = frmPrincipal.txtFecha.value.substr(6,4)+frmPrincipal.txtFecha.value.substr(3,2)+frmPrincipal.txtFecha.value.substr(0,2);
		document.all.ifraExcel.src="rep_AnulaExcel.aspx?pfecha="+strFecha+"&pcajero="+frmPrincipal.CboCajero.value;
		//alert("rep_AnulaExcel.aspx?pfecha="+strFecha);
	}
