<%@ Page Language="vb" AutoEventWireup="false" Codebehind="rep_DiarioDetIndExcel.aspx.vb" Inherits="SisCajas.rep_DiarioDetIndExcel" enableViewState="False"%>
	...
	<body leftMargin="0" topMargin="0" marginheight="0" marginwidth="0">
		<form id="frmPrincipal" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="1000" border="0">
				<tr>
					<td colSpan="4">Detalle de Diario Electrónico - Individual</td>
				<tr>
				</tr>
			</table>
			<table>
			...
			<INPUT id="txtUsuario" type="hidden" name="txtUsuario" runat="server">
		</form>
	</body>
</HTML>
