<%@ Page Language="vb" AutoEventWireup="false" Codebehind="repRemesas.aspx.vb" Inherits="SisCajas.repRemesas"%>
<HTML>
	<HEAD>
																			...
																			<tr>
																				...
																				<td class="Arial12b" width="200">
																					<input name="txtFechaIni" type="text" class="clsInputEnable" id="txtFechaIni" tabindex="34"
																						size="10" maxlength="10" value='<%=Format(Now.Day, "00") & "/" & Format(Now.Month, "00") & "/" & Format(Now.Year, "0000")%>'> <a href="javascript:show_calendar('frmPrincipal.txtFechaIni');" onMouseOut="window.status='';return true;"
																				...
																				<td class="Arial12b" width="200">
																					<input name="txtFechaFin" type="text" class="clsInputEnable" id="txtFechaFin" tabindex="34"
																						size="10" maxlength="10" value='<%=Format(Now.Day, "00") & "/" & Format(Now.Month, "00") & "/" & Format(Now.Year, "0000")%>'> <a href="javascript:show_calendar('frmPrincipal.txtFechaFin');" onMouseOut="window.status='';return true;"
																						onMouseOver="window.status='Date Picker';return true;"><img border="0" src="../../images/botones/btn_Calendario.gif"></a>
																				</td>
																			</tr>
																		</table>
...
function f_Reporte()
{
   ...
   {  
		...
		document.frmExp.action="repRemesasExcel.aspx?strFecIni=" + strFechaIni + "&strFecFin=" + strFechaFin 
