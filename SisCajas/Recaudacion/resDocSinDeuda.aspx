<%@ Page Language="vb" AutoEventWireup="false" Codebehind="resDocSinDeuda.aspx.vb" Inherits="SisCajas.resDocSinDeuda"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>resDocSinDeuda</title>
				...
				<tr>
					<td>
						<table style="BORDER-RIGHT: #336699 2px solid; BORDER-TOP: #336699 2px solid; BORDER-LEFT: #336699 2px solid; BORDER-BOTTOM: #336699 2px solid"
							...
							<thead>
								<tr>
									<td class="TituloRConsulta" align="center">Recaudación adelantada PostPago</td>
								</tr>
							</thead>
							<tbody>
								<tr>
										...
										<table class="Arial12b" cellPadding="3">
											...
											<tbody>
												...
												<tr>
													...
													<td><input class="clsInputDisable" id="txtTipoCli" readOnly type="text" size="16" name="txtTipoCli"
															runat="server"></td>
													<td></td>
													<td></td>
												</tr>
											...
											<tbody>
												<tr class="RowEven">
													<td style="HEIGHT: 20px">
														<!--PROY-27440 INI-->
														<asp:dropdownlist id="cboTipDocumento1" onChange="javascript:RedondearEfectivo('txtMonto1','cboTipDocumento1');f_bloqueo_fila(this,1);"
															tabIndex="6" runat="server" CssClass="clsSelectEnable" AutoPostBack="True"></asp:dropdownlist><!--INICIATIVA-318-->
														<!--PROY-27440 FIN-->
													</td>
													<td style="HEIGHT: 20px"><asp:textbox id="txtDoc1" tabIndex="7" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
													<td style="HEIGHT: 20px">
														<asp:textbox id="txtMonto1" onkeyup="javascript:RedondearEfectivo('txtMonto1','cboTipDocumento1');"
												...
												<tr class="RowOdd">
													<td>
														<!--PROY-27440 INI-->
														<asp:dropdownlist id="cboTipDocumento2" onChange="javascript:RedondearEfectivo('txtMonto2','cboTipDocumento2');f_bloqueo_fila(this,2);"
															tabIndex="9" runat="server" CssClass="clsSelectEnable" AutoPostBack="True"></asp:dropdownlist><!--INICIATIVA-318-->
														<!--PROY-27440 FIN-->
													</td>
													<td><asp:textbox id="txtDoc2" tabIndex="10" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
													<td>
														<asp:textbox id="txtMonto2" onkeyup="javascript:RedondearEfectivo('txtMonto2','cboTipDocumento2');"
															tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox>
														<!--PROY-27440 INI-->
												...
												<tr class="RowEven">
													<td>
														<!--PROY-27440 INI-->
														<asp:dropdownlist id="cboTipDocumento3" onChange="javascript:RedondearEfectivo('txtMonto3','cboTipDocumento3');f_bloqueo_fila(this,3);"
															tabIndex="12" runat="server" CssClass="clsSelectEnable" AutoPostBack="True"></asp:dropdownlist><!--INICIATIVA-318-->
														<!--PROY-27440 FIN-->
													</td>
													<td><asp:textbox id="txtDoc3" tabIndex="13" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
													<td>
														<asp:textbox id="txtMonto3" onkeyup="javascript:RedondearEfectivo('txtMonto3','cboTipDocumento3');"
															tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox>
														<!--PROY-27440 INI-->
