Public Class visorVentaFact_vendedor
...
#Region "Eventos"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Not IsPostBack Then
                ...
                Session("visor_codVendedor") = Nothing
                Session("dgVListaVendedor") = Nothing
                Buscar()
            End If
        End If
    End Sub
    ...
    Private Sub DGLista_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DGLista.PageIndexChanged
        DGLista.DataSource = Session("dgVListaVendedor")
    ...
    Private Sub cmdAceptar_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAceptar.ServerClick
        If Len(Trim(Request.Item("rbSel"))) > 0 Then
            Session("visor_codVendedor") = Trim(Request.Item("rbSel"))
            Response.Write("<script>window.opener.f_CargarDatosVendedor();</script>")
...
#Region "Metodos"
    ...
    Private Sub Buscar()
        Try
            Dim strVendedor As String = txtFiltro.Value
            ...
            Dim dsResult As DataSet = objclsAdmCaja.GetVendedores(strVendedor.ToUpper(), strOficina, cteVendedor)

            Session("dgVListaVendedor") = dsResult.Tables(0)
            Me.DGLista.DataSource = Session("dgVListaVendedor")
