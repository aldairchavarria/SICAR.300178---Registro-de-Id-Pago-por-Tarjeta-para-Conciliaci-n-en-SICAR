<%@ Page Language="vb" AutoEventWireup="false" Codebehind="sicar_pagoClienteCastigado.aspx.vb" Inherits="SisCajas.sicar_pagoClienteCastigado" %>
...
<HTML>
	...
	<BODY onload="Javascript:history.go(1);RedondearInicio();f_datos_POS();" onunload="Javascript:history.go(1);">
		.
		...
		//PROY-31949 - FIN
			...
			function f_EnvioPOS(intFila,TagOpcion)
			{
				...
				varNameTipoPOS = "HidTipPOS" + intFila; //PROY-31949
					...
					if(document.frmPrincipal.elements[i].name.substring(0,15)=="cboTipDocumento"){
						...
						if(document.frmPrincipal.elements[i].value!=""){
							if(document.frmPrincipal.elements[i+2].value==""){
								...
								montoTotal+= document.frmPrincipal.elements[i+2].value * 1;
							 }
						}
					}
				}					
				if(montoTotal<=0){
					alert('Monto de pago invalido');
					return false;
				}				
				return true;
			}
	...
	//PROY-27440			
		...
		<form id="frmPrincipal" method="post" runat="server">
				...
				<tr>
					<td>
						<table style="BORDER-RIGHT: #336699 2px solid; BORDER-TOP: #336699 2px solid; BORDER-LEFT: #336699 2px solid; BORDER-BOTTOM: #336699 2px solid"
							...
							<thead>
								<tr>
									<td class="TituloRConsulta" align="center">Recaudación - Pago de Clientes 
										Castigados</td>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td>
										<table class="Arial12b" style="WIDTH: 712px; HEIGHT: 106px" cellPadding="3">
											<thead>
												<tr>
													<td class="Arial12br" style="WIDTH: 404px" colSpan="3">Datos Cliente</td>
											...
											<tbody>
												<tr>
													<td style="HEIGHT: 25px">Doc. Identidad:</td>
													<td style="WIDTH: 133px; HEIGHT: 25px"><input class="clsInputDisable" id="txtIdentificadorCliente" style="WIDTH: 120px; HEIGHT: 17px"
															readOnly type="text" maxLength="30" size="14" name="txtIdentificadorCliente" runat="server"></td>
													<td style="WIDTH: 123px; HEIGHT: 25px">Nombre Cliente:</td>
													<td style="HEIGHT: 25px"><input class="clsInputDisable" id="txtNombreCliente" style="WIDTH: 276px; HEIGHT: 17px"
															readOnly type="text" size="40" name="txtNombreCliente" runat="server"></td>
												</tr>
												<tr>
													<td>Cantidad Documentos:</td>
													<td style="WIDTH: 133px"><input class="clsInputDisable" id="txtNumeroDocumentos" readOnly type="text" size="3" name="txtNumeroDocumentos"
															runat="server"></td>
													<td style="WIDTH: 123px">Valor Deuda:</td>
													<td><input class="clsInputDisable" id="txtValorDeuda" readOnly type="text" size="12" name="txtValorDeuda"
															runat="server"></td>
												</tr>
												<tr>
													<td>Tipo de Cliente:</td>
													<td style="WIDTH: 133px"><input class="clsInputDisable" id="txtTipoCli" style="WIDTH: 120px; HEIGHT: 17px" readOnly
															type="text" size="14" name="txtTipoCli" runat="server"></td>
											...
											<tbody>
												<tr class="RowEven">
													<td style="HEIGHT: 20px">
														<!--PROY-27440 INI-->
														<asp:dropdownlist id="cboTipDocumento1" onChange="javascript:MontoEfectivoRestriccion(f_CalculoDeuda_TablaMiles('tabla','6','2'),'txtMonto1','txtMonto1','txtMonto2','txtMonto3','cboTipDocumento1');RedondearEfectivo('txtMonto1','cboTipDocumento1');f_bloqueo_fila(this,1);"
															tabIndex="6" runat="server" CssClass="clsSelectEnable"></asp:dropdownlist>
														<!--PROY-27440 FIN-->
													</td>
													<td style="HEIGHT: 20px"><asp:textbox id="txtDoc1" tabIndex="7" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
													<td style="HEIGHT: 20px">
														<asp:textbox id="txtMonto1" onkeyup="javascript:MontoEfectivoRestriccionSuperaMonto(f_CalculoDeuda_TablaMiles('tabla','6','2'),'txtMonto1','txtMonto1','txtMonto2','txtMonto3','cboTipDocumento1');RedondearEfectivo('txtMonto1','cboTipDocumento1');"
															tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox>
														<!--PROY-27440 INI-->
														<A style="VISIBILITY: hidden" id="LnkPos1" onclick="blnClosingMod = false; f_EnvioPOS(1,'Envio POS');"
															runat="server"><IMG style="CURSOR: hand" id="icoTranPos1" border="0" alt="Envio POS" src="../images/send-icon.png"
																runat="server"> </A><A style="VISIBILITY: hidden" id="LnkDelPos1" onclick="blnClosingMod = false; f_EnvioPOS(1,'Eliminar POS');">
															<IMG style="CURSOR: hand" id="icoDelPos1" border="0" alt="Eliminar POS" src="../images/delete-icon.png">
												...
												<tr class="RowOdd">
													<td>
														<!--PROY-27440 INI-->
														<asp:dropdownlist id="cboTipDocumento2" onChange="javascript:MontoEfectivoRestriccion(f_CalculoDeuda_TablaMiles('tabla','6','2'),'txtMonto2','txtMonto1','txtMonto2','txtMonto3','cboTipDocumento2');RedondearEfectivo('txtMonto2','cboTipDocumento2');f_bloqueo_fila(this,2);"
															tabIndex="9" runat="server" CssClass="clsSelectEnable"></asp:dropdownlist>
														<!--PROY-27440 FIN-->
													</td>
													<td><asp:textbox id="txtDoc2" tabIndex="10" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
													<td>
														<asp:textbox id="txtMonto2" onkeyup="javascript:MontoEfectivoRestriccionSuperaMonto(f_CalculoDeuda_TablaMiles('tabla','6','2'),'txtMonto2','txtMonto1','txtMonto2','txtMonto3','cboTipDocumento2');RedondearEfectivo('txtMonto2','cboTipDocumento2');"
															tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox>
														<!--PROY-27440 INI-->
														<A style="VISIBILITY: hidden" id="LnkPos2" onclick="blnClosingMod = false; f_EnvioPOS(2,'Envio POS');">
															<IMG style="CURSOR: hand" id="icoTranPos2" border="0" alt="Envio POS" src="../images/send-icon.png">
														</A><A style="VISIBILITY: hidden" id="LnkDelPos2" onclick="blnClosingMod = false; f_EnvioPOS(2,'Eliminar POS');">
															<IMG style="CURSOR: hand" id="icoDelPos2" border="0" alt="Eliminar POS" src="../images/delete-icon.png">
												...
												<tr class="RowEven">
													<td>
														<!--PROY-27440 INI-->
														<asp:dropdownlist id="cboTipDocumento3" onChange="javascript:MontoEfectivoRestriccion(f_CalculoDeuda_TablaMiles('tabla','6','2'),'txtMonto3','txtMonto1','txtMonto2','txtMonto3','cboTipDocumento3');RedondearEfectivo('txtMonto3','cboTipDocumento3');f_bloqueo_fila(this,3);"
															tabIndex="12" runat="server" CssClass="clsSelectEnable"></asp:dropdownlist>
														<!--PROY-27440 FIN-->
													</td>
													<td><asp:textbox id="txtDoc3" tabIndex="13" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
													<td><asp:textbox id="txtMonto3" onkeyup="javascript:MontoEfectivoRestriccionSuperaMonto(f_CalculoDeuda_TablaMiles('tabla','6','2'),'txtMonto3','txtMonto1','txtMonto2','txtMonto3','cboTipDocumento3');RedondearEfectivo('txtMonto3','cboTipDocumento3');"
															tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox>
														<!--PROY-27440 INI-->
														<A style="VISIBILITY: hidden" id="LnkPos3" onclick="blnClosingMod = false; f_EnvioPOS(3,'Envio POS');">
															<IMG style="CURSOR: hand" id="icoTranPos3" border="0" alt="Envio POS" src="../images/send-icon.png">
														</A><A style="VISIBILITY: hidden" id="LnkDelPos3" onclick="blnClosingMod = false; f_EnvioPOS(3,'Eliminar POS');">
															<IMG style="CURSOR: hand" id="icoDelPos3" border="0" alt="Eliminar POS" src="../images/delete-icon.png">
										...
										<br>
										<table class="Arial12b" cellPadding="3" id="tabla">
											<thead>
												<tr>
													<td class="Arial12br" colSpan="7">Documentos</td>
												</tr>
												<tr>
													<td class="ColumnHeader" style="HEIGHT: 17px">Tipo Documento</td>
													<td class="ColumnHeader" style="HEIGHT: 17px">Número Documento</td>
													<td class="ColumnHeader" style="HEIGHT: 17px">Descripción Servicio</td>
													<td class="ColumnHeader" style="HEIGHT: 17px">Fecha Emisión</td>
													<td class="ColumnHeader" style="HEIGHT: 17px">Fecha Vencimiento</td>
													<td class="ColumnHeader" style="HEIGHT: 17px">Moneda</td>
													<td class="ColumnHeader" style="HEIGHT: 17px">Total</td>
												</tr>
											</thead>
											<tbody>
												<%
												...
												<tr class="<%=strClaseFila%>">
													...
													<td><%=arrRecibo(cteRECIBO_DESCRIPCIONSERVICIO)%></td>
													<td><%=FormateoFecha(arrRecibo(cteRECIBO_FECHAEMISION),0)%></td>
													<td><%=FormateoFecha(arrRecibo(cteRECIBO_FECHAVENCIMIENTO),0)%></td>
													<td><%=FormateoMoneda(arrRecibo(cteRECIBO_MONEDASERVICIO),cteCODMONEDA_SOLES)%></td>
													<td align="right"><%=FormateoMonto(arrRecibo(cteRECIBO_MONTODOCUMENTO)).tostring("N2")%>
											...
											<td vAlign="middle" width="100%">
												<table class="Arial12B" cellSpacing="2" cellPadding="0" width="90%" align="center" border="0">
													<tr>
														...
														<td><asp:textbox id="txtRecibidoPen" tabIndex="10" runat="server"
			...
			<!-- Valor que determina que es PostBack --><input id="hdnMensaje" type="hidden" name="hdnMensaje" runat="server">
			...
			<input id="txtNumeroTrace" type="hidden" name="txtNumeroTrace" runat="server"> <input id="hdnRutaLog" type="hidden" name="hdnRutaLog" runat="server">
			<input id="hdnDetalleLog" type="hidden" name="hdnDetalleLog" runat="server"> <input id="txtTipoIdentificador" type="hidden" name="txtTipoIdentificador" runat="server">
			<input id="txtIdentificador" type="hidden" name="txtIdentificador" runat="server">
			<input id="hdnEjecutado" type="hidden" value="I" name="hdnEjecutado" runat="server">
			...
			<input id="HidMonedaVisa" type="hidden" name="HidMonedaVisa" runat="server"> <input id="HidDatoPosVisa" type="hidden" name="HidDatoPosVisa" runat="server">
