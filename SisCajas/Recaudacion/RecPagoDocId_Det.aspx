<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RecPagoDocId_Det.aspx.vb" Inherits="SisCajas.RecPagoDocId_Det"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>RecPagoDocId_Det</title>
	...
	{	
		...
		switch (intFila)
		{
			...
			case 3:
		        ...
		        document.getElementById(varNameTdoc).disabled = false;
			...
			break;
		        ...
		        else
		        {
					...
					document.getElementById(varNameTdoc).value = "";
					document.getElementById(varNameTdoc).disabled = true;		
	}
	}
			...
			function f_EnvioPOS(intFila,TagOpcion)
			{
				...
				//if(varNameTipoPOS == null || varNameTipoPOS == '') Cuqui
		...
		varIpPos = '';
		        ...
		        var idRecaudacion = document.getElementById("txtIdentificador").value;//Proy-31949 Cuqui
				var varNroPedido = '';
				var varNroTelefono = '';
				varNroPedido = document.getElementById("txtIdentificador").value; 
				varNroTelefono = document.getElementById("txtIdentificador").value; 
				varTransMonto= '';
	...
	try
	{
		...
		if (contPagosPos == 0)
		{
			document.getElementById("btnCancelar").disabled = false;
						...
						document.getElementById("cmdBuscar").disabled = false;
						blnClosingMod=false;
						//Proy-31949 Fin
		}
		else
		{
					document.getElementById("btnCancelar").disabled = true;
						...
						document.getElementById("cmdBuscar").disabled = true;
						blnClosingMod=true;
						//Proy-31949 Fin
				}
			}
	...
	function ErrorMasterCard(request,NameDoc,objEntityPOS)
	{
      ...
      varNroReferencia = '';
			...
			var varNomCliente = document.getElementById("hidNomCliente").value;
			var varNroTelefono = document.getElementById("txtIdentificador").value;
			var varNroPedido = document.getElementById("txtIdentificador").value; 
			var varTramaAudit = '';    
	...
	function SuccessVisaNet(objResponse,NameDoc)
	{
		try{
			...
			var varMsgAlert = '';
			var varPrintData = '';
					var varNroPedido = document.getElementById("txtIdentificador").value;//Proy-31949; 
			var varIdUnicoTrans = '';
			var varFlagPago = '1';
			var varIdCabez = document.getElementById("HidIdCabez").value;
	...
	function SuccessMasterCard(objResponse,NameDoc)
	{
		...
		try{
			...
			'|TipoTrans=' + varTipoTrans + '|IdRefAnulador=' + varIdRefAnu +
					...
					var varRpta = RSExecute(serverURL,"ActualizarTransaction",varTramaUpdate, objEntityPOS.TrnsnId,CallBack_ActTransMCD,GuardarTransactionError,"X");//Proy-31949
	...
	//PROY-27440 FIN	
       ...
       function SeleccionX(){
		var combo = $('#cboTipDocumento1').val();
		if(combo == '') //Vacio
		{ 
		...
		f_Recalcular($('#cboTipDocumento1'));
}
	
		function EnableEnterForm(e){
		...
		function ValidaNumero(obj){
			...
			if (!(KeyAscii >= 46 && KeyAscii<=57) | (KeyAscii==46 && obj.value.indexOf(".")>=0) | KeyAscii == 13 ){		
				alert(KeyAscii);
			...
			{	
				if (obj.value.indexOf(".")>=0 ){		
					if (KeyAscii!=46  && obj.value.substring(obj.value.indexOf(".")+1,obj.value.length).length>1 && KeyAscii == 13)
						alert(KeyAscii);
						window.event.keyCode = 0;	
				}
			}
		...
		function solonumeros(e) {
			...
			function f_Recalcular(obj){
				...
				/*if (suma > document.frmPrincipal.txtValorDeuda.value){
	...
	function ValidateFloatKeyPress(el, evt) {
		...
		if (caratPos > dotPos && dotPos > -1 && number[1].length > 1) {
			if (charCode == 8 && el.value.length > 1)
				return true;
			return false;
		}
		return true;
	...
	FILTER: alpha(opacity=50); CURSOR: wait; -moz-opacity: 0.5; -khtml-opacity: 0.5; opacity: 0.5
}
.modal-backdrop {
	Z-INDEX: -100 !important; POSITION: relative; BACKGROUND-COLOR: #f4f6f7; DISPLAY: block; CURSOR: wait
}
		</style>
	</HEAD>
	<body MS_POSITIONING="GridLayout">
		<form id="frmPrincipal" onkeypress="return EnableEnterForm(event)" method="post" runat="server">
			<table border="0" cellSpacing="0" cellPadding="0" width="950">
				<tr>
					<td>
						<div style="HEIGHT: 150px" id="divEfecto">
							<table style="BORDER-BOTTOM: #336699 2px solid; BORDER-LEFT: #336699 2px solid; BORDER-TOP: #336699 2px solid; BORDER-RIGHT: #336699 2px solid"
								border="0" cellSpacing="0" cellPadding="5" align="left">
								<thead>
									<tr>
										<td class="TituloRConsulta" align="center">Recaudación de Clientes por DNI</td>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>
																...
																<td>
																	<table border="0" cellSpacing="2" cellPadding="2" width="450">
																		<tr>
																			...
																			<td style="WIDTH: 108px" class="Arial12b" width="108">&nbsp;Número de DNI:</td>
																			<td class="Arial12b" width="100"><asp:textbox id="txtDNI" onkeypress="return solonumeros(event)" runat="server"
																					MaxLength="8" CssClass="clsInputEnable" Width="125px" name="txtDNI"></asp:textbox></td>
																			<td width="95"><asp:button id="cmdBuscar" runat="server" CssClass="BotonOptm" Width="100px" Text="Buscar"></asp:button></td>
																		</tr>
																		<tr>
																			<td style="WIDTH: 10px"></td>
																			<td style="WIDTH: 108px" class="Arial12b" width="108">&nbsp;Tipo de Servicio:</td>
																			<td class="Arial12b" width="125"><asp:dropdownlist id="cboTipoServicio" class="Arial12b" runat="server" Width="125px" name="cboTipoServicio">
											...
											<table class="Arial12b" cellPadding="3">
												<colgroup>
													...
													<col align="center" width="387">
													<col align="center" width="300">
												</colgroup>
												<thead>
													<tr>
														<td style="TEXT-ALIGN: left" class="Arial12br" colSpan="3">Cantidad Documentos
															<asp:textbox id="txtCantDoc" tabIndex="7" runat="server" CssClass="clsInputDisable" Width="70px"
																ReadOnly="True"></asp:textbox>&nbsp;&nbsp;&nbsp;&nbsp; Monto Total
															<asp:textbox style="TEXT-ALIGN: right" id="txtMontoTotalDni" tabIndex="7" runat="server" CssClass="clsInputDisable"
												...
												<tbody>
													<tr class="RowEven">
														<td style="HEIGHT: 25px"><asp:dropdownlist id="cboTipDocumento1" tabIndex="6" runat="server" CssClass="clsSelectEnable" onChange="f_bloqueo_fila(this,1);"
																AutoPostBack="True"></asp:dropdownlist></td> <!--INICIATIVA-318-->
														<td style="HEIGHT: 25px"><asp:textbox id="txtDoc1" tabIndex="7" onkeypress="return solonumeros(event)" onpaste="return false;"
																runat="server" MaxLength="20" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
														<td style="HEIGHT: 25px"><asp:textbox style="TEXT-ALIGN: right" id="txtMonto1" tabIndex="8"  onkeypress="return ValidateFloatKeyPress(this, event)"
																onpaste="return false;" runat="server" MaxLength="9" CssClass="clsInputEnable" Width="147px"></asp:textbox>
															<!--PROY-27440 INI-->	<A id="LnkPos1" style="DISPLAY:none" runat="server"><IMG id="icoTranPos1" style="CURSOR: hand" alt="Envio POS" src="../images/send-icon.png"
																	border="0" runat="server"> </A>
															<!--PROY-31949 INI-->
															<a id="LnkPrintPos1" style="DISPLAY:none"><img id="icoPrintPOS1" style="CURSOR:hand" alt="Imprimir" src="../images/print-icon.png"
																	border="0"> </a>
															<!--PROY-31949 INI-->
															<A id="LnkDelPos1" style="DISPLAY:none"><IMG id="icoDelPos1" style="CURSOR: hand" alt="Eliminar POS" src="../images/delete-icon.png"
																	border="0"> </A><input id="HidTipPOS1" type="hidden" name="HidTipPOS1" runat="server">
															<!--PROY-27440 FIN--></td>
													</tr>
													<tr class="RowOdd">
														<td style="HEIGHT: 25px"><asp:dropdownlist id="cboTipDocumento2" tabIndex="9" runat="server" CssClass="clsSelectEnable" onChange="f_bloqueo_fila(this,2);"
																AutoPostBack="True"></asp:dropdownlist></td><!--INICIATIVA-318-->
														<td style="HEIGHT: 25px"><asp:textbox id="txtDoc2" tabIndex="10" onkeypress="return solonumeros(event)" onpaste="return false;"
																runat="server" MaxLength="20" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
														<td style="HEIGHT: 25px"><asp:textbox style="TEXT-ALIGN: right" id="txtMonto2" tabIndex="8"  onkeypress="return ValidateFloatKeyPress(this, event)"
																onpaste="return false;" runat="server" MaxLength="9" CssClass="clsInputEnable" Width="147px"></asp:textbox>
															<!--PROY-27440 INI-->	<A id="LnkPos2" style="DISPLAY:none"><IMG id="icoTranPos2" style="CURSOR: hand" alt="Envio POS" src="../images/send-icon.png"
																	border="0"> </A>
															<!--PROY-31949 INI-->
															<a id="LnkPrintPos2" style="DISPLAY:none"><img id="icoPrintPOS2" style="CURSOR:hand" alt="Imprimir" src="../images/print-icon.png"
																	border="0"> </a>
															<!--PROY-31949 INI-->
															<A id="LnkDelPos2" style="DISPLAY:none"><IMG id="icoDelPos2" style="CURSOR: hand" alt="Eliminar POS" src="../images/delete-icon.png"
																	border="0"> </A><input id="HidTipPOS2" type="hidden" name="HidTipPOS2" runat="server">
															<!--PROY-27440 FIN--></td>
													</tr>
													<tr class="RowEven">
														<td><asp:dropdownlist id="cboTipDocumento3" tabIndex="12" runat="server" CssClass="clsSelectEnable" onChange="f_bloqueo_fila(this,3);"
																AutoPostBack="True"></asp:dropdownlist></td> <!--INICIATIVA-318-->
														<td><asp:textbox id="txtDoc3" tabIndex="13" onkeypress="return solonumeros(event)" onpaste="return false;"
																runat="server" MaxLength="20" CssClass="clsInputEnable" Width="147px"></asp:textbox></td>
														<td style="HEIGHT: 25px"><asp:textbox style="TEXT-ALIGN: right" id="txtMonto3" tabIndex="8"  onkeypress="return ValidateFloatKeyPress(this, event)"
																onpaste="return false;" runat="server" MaxLength="9" CssClass="clsInputEnable" Width="147px"></asp:textbox>
															<!--PROY-27440 INI-->	<A id="LnkPos3" style="DISPLAY:none"><IMG id="icoTranPos3" style="CURSOR: hand" alt="Envio POS" src="../images/send-icon.png"
																	border="0"> </A>
															<!--PROY-31949 INI-->
															<a id="LnkPrintPos3" style="DISPLAY:none"><img id="icoPrintPOS3" style="CURSOR:hand" alt="Imprimir" src="../images/print-icon.png"
																	border="0"> </a>
															<!--PROY-31949 INI-->
															<A id="LnkDelPos3" style="DISPLAY:none"><IMG id="icoDelPos3" style="CURSOR: hand" alt="Eliminar POS" src="../images/delete-icon.png"
																	border="0"> </A><input id="HidTipPOS3" type="hidden" name="HidTipPOS3" runat="server">
															<!--PROY-27440 FIN--></td>
													</tr>
													<tr>
														<td align="center" colSpan="7"><asp:label id="lblEnvioPos" runat="server" CssClass="TituloRConsulta"></asp:label></td>
													</tr>
													<!--PROY-27440 FIN-->
												</tbody>
											</table>
											<span id="spanImage">
												<center><IMG style="Z-INDEX: 101 !important; MARGIN-TOP: -3px; MARGIN-BOTTOM: -3px" class="imgLoad"
														alt="alt" src="../images/c_loader.gif"></center>
											</span><span class="TituloRConsulta">
												<center>Documentos pendientes de pago</center>
											</span>
											<table style="WIDTH: 100%; BORDER-COLLAPSE: collapse" id="tblCuentas" class="Arial12b"
												cellSpacing="0" borderColor="#393939" cellPadding="3">
												<colgroup>
												...
												<thead>
													<tr align="center">
														...
														<td class="ColumnHeader">Cuenta</td>
														<td class="ColumnHeader">Nombre</td>
														<td class="ColumnHeader">Telf. referencia</td>
														<td class="ColumnHeader">Recibo</td>
														<td class="ColumnHeader">Fec. emision</td>
														<td class="ColumnHeader">Fec. vencimiento</td>
														<td class="ColumnHeader">Moneda</td>
											...
											<div style="BORDER-BOTTOM: #336699 1px solid; BORDER-LEFT: #336699 1px solid; MARGIN-TOP: 1px; BORDER-TOP: #336699 1px solid; BORDER-RIGHT: #336699 1px solid"
												align="left">&nbsp; <label class="Arial12B">Registros por Pagina </label>
												<select id="cboPaginado">
													<% 
															Dim paginado$ = ConfigurationSettings.AppSettings("PaginadoPagoDni")
															Dim oArray() As String = paginado.Split(",")
															Dim i%
															For i = 0 To oArray.Length - 1
														%>
													<option selected value="<%=oArray(i) %>"><%=oArray(i) %></option>
													<% Next %>
												</select>
												&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
												&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
												&nbsp; &nbsp; &nbsp; &nbsp; <input style="HEIGHT: 22px" id="btnPrimero" class="BotonOptm" value="|<" type="button">
												<input style="HEIGHT: 22px; MARGIN-LEFT: -3px" id="btnAntes" class="BotonOptm" value="<<"
													type="button"> &nbsp; <label id="lblTotPaginas" class="Arial12B">Cantidad de 
													Paginas : 0 </label>&nbsp; <input style="HEIGHT: 22px; MARGIN-RIGHT: -3px" id="btnSiguiente" class="BotonOptm" value=">>"
													type="button"> <input style="HEIGHT: 22px" id="btnUltimo" class="BotonOptm" value=">|" type="button">
											</div>
																...
																<td vAlign="middle" width="100%">
																	<table class="Arial12B" border="0" cellSpacing="2" cellPadding="0" width="90%" align="center">
																		<tr>
																			...
																			<td><asp:textbox style="TEXT-ALIGN: right" id="txtRecibidoPen" tabIndex="10" onkeypress="return NumCheck(event, this)"
																					onpaste="return false;" runat="server" MaxLength="9" CssClass="clsInputEnable"></asp:textbox></td>
																			<td id="tdVuelto">Vuelto:</td>
																		...
																		<tr>
																			...
																			<td><asp:textbox style="TEXT-ALIGN: right" id="txtRecibidoUsd" tabIndex="10" onkeypress="return NumCheck(event, this)"
																					onpaste="return false;" runat="server" MaxLength="9" CssClass="clsInputEnable">0.00</asp:textbox></td>
																			<td></td>
																			<td></td>
																		</tr>
																	</table>
											...
											<table id="tblBotones" border="0" cellSpacing="0" cellPadding="0" align="left">
												<tr>
													<td>
														<table border="1" cellSpacing="0" borderColor="#336699" cellPadding="0" width="500" align="center">
															<tr>
																<td align="center">
																	<div style="DISPLAY: block" id="divBotones">
																		<table border="0" cellSpacing="2" cellPadding="0">
																			<tr>
																				<td width="28" align="center"></td>
																				<td width="60" align="center"><asp:button id="btnGrabar" runat="server" CssClass="BotonOptm" Width="100px" Text="Grabar"></asp:button></td>
																				<td width="28" align="center"></td>
																				<td width="60" align="center"><asp:button id="btnCancelar" runat="server" CssClass="BotonOptm" Width="100px" Text="Cancelar"></asp:button></td>
																				<td width="28" align="center"></td>
																				<td width="60" align="center"><asp:button id="btnLimpiar" runat="server" CssClass="BotonOptm" Width="100px" Text="Limpiar"></asp:button></td>
																				<td width="28" align="center"></td>
																			</tr>
																		</table>
																	</div>
														...
														<!-- Atributos de la Página --><input style="WIDTH: 8px" id="hdnPuntoDeVenta" type="hidden" name="hdnPuntoDeVenta" runat="server">
														...
														<input style="WIDTH: 8px" id="txtNumeroTrace" type="hidden" name="txtNumeroTrace" runat="server">
														...
														<input style="WIDTH: 8px" id="hdTipoCambio" type="hidden" name="hdTipoCambio" runat="server">
														<input style="WIDTH: 8px" id="hdnombreComercio" type="hidden" name="hdnombreComercio" runat="server">
														<input style="WIDTH: 8px" id="hdCodAquirienteReenvia" type="hidden" name="hdCodAquirienteReenvia"
															runat="server"> <input style="WIDTH: 8px" id="txtTipoIdentificador" type="hidden" name="txtTipoIdentificador"
															runat="server"> <INPUT style="WIDTH: 8px" id="hidRecibos" type="hidden" name="hidRecibos" runat="server">
														<input style="WIDTH: 8px" id="txtIdentificador" type="hidden" name="txtIdentificador" runat="server">
														<input style="WIDTH: 8px" id="hdDeudaPorCuenta" type="hidden" name="hdDeudaPorCuenta" runat="server">
														...
														<input id="hidNomCliente" type="hidden" name="hidNomCliente" runat="server"> 
														<!--PROY-27440 FIN-->
                                                                                                                  <!--PROY-31949 INI-->
                                                                                                                  <input type="hidden" id="hidResponseDoc" name="hidResponseDoc"> <input type="hidden" id="hdnMsgMayor" name="hdnMsgMayor" runat="server">
                                                                                                                  <input type="hidden" id="hdnMsgMenor" name="hdnMsgMenor" runat="server"> <input id="HidNumIntentosPago" type="hidden" name="HidNumIntentosPago" runat="server">
                                                                                                                  ...
                                                                                                                  <input type="hidden" id="HidMedioPagoPermitidas" name="HidMedioPagoPermitidas" runat="server">
														  <!--INICIATIVA-318 INI-->
														...
														<p style="DISPLAY: none">
															<asp:textbox id="txtTarjCred" runat="server"></asp:textbox>
		...
		<script language="JavaScript" src="../librerias/Lib_DeudaDNI.js"></script>
	</body>
</HTML>
