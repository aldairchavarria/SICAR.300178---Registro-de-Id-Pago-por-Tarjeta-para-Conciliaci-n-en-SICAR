<%@ Page Language="vb" AutoEventWireup="false" Codebehind="docRecBusiness.aspx.vb" Inherits="SisCajas.docRecBusiness"%>
...
<HTML>
	...
	function f_EnvioPOS(intFila,TagOpcion)
	{
	  ...
	  varMonedaVisa = '';
		...
		varNroPedido = document.getElementById("txtIdentificadorCliente").value; 
		varNroTelefono = ''; 
	...
	//PROY-27440 FIN	
	    ...
	    function f_Imprimir(){
			...
			var strMontoFavor = "<%=request.item("strMontoFavor")%>";
			...
			objIframe.src = "impRecBusiness.aspx?NombreCliente=" + NombreCliente + "&MontoTotalPagado=" + MontoTotalPagado +  "&strTrama=" + strTrama + "&strRecibos=" + strRecibos + "&strMontoFavor=" + strMontoFavor;
		}
		...
		function f_VerificaMonto(obj,numero)
		{
		  var MontoIng = parseFloat(obj.value);
		  var control = "DGReporte.rows[" + (numero-1) + "].cells[6]";
		  var MontoPen;
		  var MontoPen2 = "";
		  
		  eval("MontoPen = " + control +  ".innerText;");
		  
		  //filtrando la coma para que no altere la conversion con parseFloat
		  for (i=0;i<MontoPen.length;i++)
		  {
		    if (MontoPen.substring(i,i+1) != ",")
		       MontoPen2 += MontoPen.substring(i,i+1);
		  }
		 
		  MontoPen = parseFloat(MontoPen2);
		 
		  /*if (MontoIng > MontoPen)
		  {
		    alert("No puede ingresar un monto mayor al del recibo");
		    obj.value = MontoPen;
		  }*/
			...
			for(i=0; i<document.frmPrincipal.elements.length; i++){
				...
				if(document.frmPrincipal.elements[i].name.substring(0,8)=="txtMonto"){
					if(document.frmPrincipal.elements[i].value!=""){
						...
						TotalMon += parseFloat(document.frmPrincipal.elements[i].value);
					}
				}
				valor=""
	 ...
	 var varIntAutPos = document.getElementById("HidIntAutPos").value;
		...
		function CalculoVuelto(){
			...
			suma= Math.round(parseFloat(suma)*100)/100;		//nhuaringa 10072012
		...
		function f_Recalcular(obj){
			...
			/*if (suma > document.frmPrincipal.txtValorDeuda.value){
                ...
                document.getElementById("tdTotal").innerText = "Total: " + suma;
				CalculoVuelto();
		}
		...
		function f_CheckAll()
		{
			if(DGReporte.rows[0].cells[0].children[0].checked){
				for (i=1;i < DGReporte.rows.length; i++){
					DGReporte.rows[i].cells[0].children[0].checked = true;
				}
			}else{
				for (i=1;i < DGReporte.rows.length; i++){
					DGReporte.rows[i].cells[0].children[0].checked = false;
				}
			}
		}
	...
	<body onload="javascript:RedondearInicio();f_datos_POS();">
		<form id="frmPrincipal" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="750" border="0">
											...
											<tbody>
												<tr class="RowEven">
													<td style="HEIGHT: 20px">
														<!--PROY-27440 INI-->
														<!--INICIATIVA-318--><asp:dropdownlist id="cboTipDocumento1" tabIndex="6" runat="server" AutoPostBack="True" CssClass="clsSelectEnable"></asp:dropdownlist>
														<!--PROY-27440 FIN-->
													</td>
													<td style="HEIGHT: 20px"><asp:textbox id="txtDoc1" tabIndex="7" runat="server" CssClass="clsInputEnable" Width="147px"
															MaxLength="18"></asp:textbox></td>
													<td style="HEIGHT: 20px">
														<!--INICIATIVA-318--><asp:textbox id="txtMonto1" 
												...
												<tr class="RowOdd">
													<td>
														<!--PROY-27440 INI-->
														<!--INICIATIVA-318--><asp:dropdownlist id="cboTipDocumento2" tabIndex="9" runat="server" AutoPostBack="True" CssClass="clsSelectEnable"></asp:dropdownlist>
														<!--PROY-27440 FIN-->
													</td>
													<td><asp:textbox id="txtDoc2" tabIndex="10" runat="server" CssClass="clsInputEnable" Width="147px"
															MaxLength="18"></asp:textbox></td>
													<td>
														<!--INICIATIVA-318--><asp:textbox id="txtMonto2" 
															tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox>
														<!--PROY-27440 INI-->
												...
												<tr class="RowEven">
													<td>
														<!--PROY-27440 INI-->
														<!--INICIATIVA-318--><asp:dropdownlist id="cboTipDocumento3" tabIndex="12" runat="server" AutoPostBack="True" CssClass="clsSelectEnable"></asp:dropdownlist>
														<!--PROY-27440 FIN-->
													</td>
													<td><asp:textbox id="txtDoc3" tabIndex="13" runat="server" CssClass="clsInputEnable" Width="147px"
															MaxLength="18"></asp:textbox></td>
													<td>
														<!--INICIATIVA-318--><asp:textbox id="txtMonto3" 
															tabIndex="8" runat="server" CssClass="clsInputEnable" Width="147px"></asp:textbox>
														<!--PROY-27440 INI-->
				...
				<tr>
					<td>
						...
						<table borderColor="#336699" cellSpacing="0" cellPadding="0" width="100%" align="center"
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
										<tr>
											<td class="TituloRConsulta" align="center">Documentos pendientes de pago
											</td>
										</tr>
									</table>
									<br>
									<div style="BORDER-BOTTOM: 1px; TEXT-ALIGN: center; BORDER-LEFT: 1px; OVERFLOW-X: scroll; OVERFLOW-Y: scroll; WIDTH: 740px; HEIGHT: 330px; BORDER-TOP: 1px; BORDER-RIGHT: 1px">
										<asp:datagrid class="Arial11B" id="DGReporte" runat="server" Width="700px" AutoGenerateColumns="False"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="RAZON_SOCIAL" HeaderText="Raz&#243;n social">
													<HeaderStyle Width="225px" CssClass="ColumnHeader"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="TELEFONO" HeaderText="Telf. referencia">
													<HeaderStyle Width="75px" CssClass="ColumnHeader"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="OHREFNUM" HeaderText="Recibo">
													<HeaderStyle Width="90px" CssClass="ColumnHeader"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="FEC_EMISION" HeaderText="Fec emisi&#243;n" DataFormatString="{0:d}">
													<HeaderStyle Width="80px" CssClass="ColumnHeader"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="FEC_VENCIMIENTO" HeaderText="Fec vencimiento" DataFormatString="{0:d}">
													<HeaderStyle Width="80px" CssClass="ColumnHeader"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="DEUDA_PENDIENTE" HeaderText="Total" DataFormatString="{0:N2}">
													<HeaderStyle Width="60px" CssClass="ColumnHeader"></HeaderStyle>
													<ItemStyle HorizontalAlign="Right" VerticalAlign="Middle"></ItemStyle>
												</asp:BoundColumn>
												<%-- nhuaringa 20/04/2012 --%>
												<%--<asp:TemplateColumn HeaderText="Sel.">
													<HeaderStyle CssClass="ColumnHeader"></HeaderStyle>
													<ItemStyle HorizontalAlign="Center"></ItemStyle>
													<ItemTemplate>
														&nbsp;
														<asp:CheckBox id="chkSelect"></asp:CheckBox>
													</ItemTemplate>
												</asp:TemplateColumn>
												<asp:TemplateColumn HeaderText="Monto a pagar">
													<HeaderStyle CssClass="ColumnHeader"></HeaderStyle>
													<ItemStyle HorizontalAlign="Center"></ItemStyle>
													<ItemTemplate>
														<asp:TextBox id="txtMontoPag" runat="server" CssClass="clsInputDisable" MaxLength="10" Width="55px"
						...
						<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
							<tr>
								<td class="Arial12B" id="tdTotal" align="right" height="10">Total :</td>
							</tr>
						</table>
						<table borderColor="#336699" cellSpacing="0" cellPadding="0" width="100%" align="center"
							border="1">
			...
			<iframe id="IfrmImpresion" style="WIDTH: 0px; HEIGHT: 0px; VISIBILITY: hidden" name="IfrmImpresion"
				src="#"></iframe>
			...
			<!-- Atributos de la Página --><input id="NombreCliente" type="hidden" name="NombreCliente" runat="server">
			<input id="MontoTotalPagado" type="hidden" name="MontoTotalPagado" runat="server">
			<input id="strTrama" type="hidden" name="strTrama" runat="server"> <input id="strRecibos" type="hidden" name="strRecibos" runat="server">
