Public Class visorRecDeuda_excel
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Try
                If Not Session("TablaDeudaOrdenado") Is Nothing Then
                    dgReporte.DataSource = CType(Session("TablaDeudaOrdenado"), DataView)
                Else
                    dtDatos = CType(Session("TablaDeuda"), DataTable)
    ...
    Private Sub dgReporte_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgReporte.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Cells(13).Style("mso-number-format") = "\@"
        End If
    End Sub
End Class
