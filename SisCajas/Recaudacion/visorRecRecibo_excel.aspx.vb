Public Class visorRecRecibo_excel
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Try
                If Not Session("TablaReciboOrdenado") Is Nothing Then
                    dgReporte.DataSource = CType(Session("TablaReciboOrdenado"), DataView)
                Else
                    dtDatos = CType(Session("TablaRecibo"), DataTable)
    ...
    Private Sub dgReporte_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgReporte.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            ...
            e.Item.Cells(4).Style("mso-number-format") = "\#\,\#\#0\.00"
