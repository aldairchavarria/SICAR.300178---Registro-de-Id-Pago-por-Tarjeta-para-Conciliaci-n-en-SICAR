<%@ Page Language="vb" AutoEventWireup="false" Codebehind="visorVentaFact_vendedor.aspx.vb" Inherits="SisCajas.visorVentaFact_vendedor" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
  <head>
    <title>visorVentaFact_vendedor</title>
    ...
    <script language="javascript">	
		...
		function f_buscar(){
			if(event.keyCode == 13 ){
				frmVVFVendedor.cmdBuscar.click();
			}
		}
	</script>
  </head>
  <body MS_POSITIONING="GridLayout">
    <form id="frmVVFVendedor" method="post" runat="server">
		<table width="375" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#336699">
			<tr>
				<td align="center">
					<asp:Label id="lblTitulo" runat="server" CssClass="TituloConsulta">Buscar Vendedor</asp:Label>
				</td>
			</tr>
		</table>
		<br>
