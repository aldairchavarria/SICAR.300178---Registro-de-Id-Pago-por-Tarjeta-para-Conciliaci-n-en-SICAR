Public Class configPaycall_oficina
...
#Region "Eventos"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Not IsPostBack Then
                ...
                Session("ConfPay_codOficina") = Nothing
                Session("dgCPListaOficina") = Nothing
                Buscar()
            End If
        End If
    End Sub
    ...
    Private Sub DGLista_PageIndexChanged(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles DGLista.PageIndexChanged
        DGLista.DataSource = Session("dgCPListaOficina")
    ...
    Private Sub cmdAceptar_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAceptar.ServerClick
        If Len(Trim(Request.Item("rbSel"))) > 0 Then
            Session("ConfPay_codOficina") = Trim(Request.Item("rbSel"))
...
#Region "Metodos"
    ...
    Private Sub Buscar()
        Try
            ...
            Session("dgCPListaOficina") = dsResult.Tables(0)
            Me.DGLista.DataSource = Session("dgCPListaOficina")
            Me.DGLista.DataBind()
