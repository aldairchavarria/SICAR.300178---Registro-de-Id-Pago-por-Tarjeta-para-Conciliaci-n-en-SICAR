Public Class visorRecTrsPago_excel
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Try
                If Not Session("TablaRecPagOrdenado") Is Nothing Then
                    dgReporte.DataSource = CType(Session("TablaRecPagOrdenado"), DataView)
                Else
                    dtDatos = CType(Session("TablaRecPag"), DataTable)
    ...
    Private Sub dgReporte_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgReporte.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            e.Item.Cells(5).Style("mso-number-format") = "\#\,\#\#0\.00"
            e.Item.Cells(6).Style("mso-number-format") = "\#\,\#\#0\.00"
            e.Item.Cells(7).Style("mso-number-format") = "\#\,\#\#0\.00"
            e.Item.Cells(8).Style("mso-number-format") = "\#\,\#\#0\.00"
            e.Item.Cells(14).Style("mso-number-format") = "\@"
        End If
    End Sub
End Class
