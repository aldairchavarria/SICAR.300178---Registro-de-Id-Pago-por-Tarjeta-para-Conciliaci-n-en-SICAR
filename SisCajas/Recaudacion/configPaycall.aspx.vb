...
#Region "Eventos"
    ...
    Private Sub cmdBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdBuscar.Click
        Try
            ...
            If hidCodOficina.Value.Equals(String.Empty) Then
                Response.Write("<script language=jscript> alert('" + "Seleccione oficina" + "'); </script>")
                Exit Sub
            Else
                Session("strCPOficinaID") = hidCodOficina.Value
                Response.Redirect("configPaycall_Lista.aspx")
            End If
    ...
    Private Sub loadDataHandler_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles loadDataHandler.Click
        Try
            ...
            If Not Session("dgCPListaOficina") Is Nothing Then
                Dim dt As DataTable = DirectCast(Session("dgCPListaOficina"), DataTable)
                If Not Session("ConfPay_codOficina") Is Nothing Then
                    Dim codigoOfi As String = CStr(Session("ConfPay_codOficina"))
                    ...
                    If Not drvResultado Is Nothing Then
                        ...
                        End With
                        hidCodOficina.Value = CStr(Session("ConfPay_codOficina"))
                    End If
                End If
            End If
