' ===============================================================================
' Creado por Roberth Ramos
' Implementar el patron Abstract Factory 
' Acceso a Datos de Oracle
' ===============================================================================
...
Public Class DAABOracleFactory
    Inherits DAABAbstracFactory

#Region "Variables Locales"
    Private m_conSql As String
    Private m_conecSQL As OracleConnection
    Private m_TranSQL As OracleTransaction
#End Region
...
#Region "Métodos privados"
    ...
    Private Sub AttachParameters(ByVal command As OracleCommand, ByVal commandParameters() As OracleParameter)
    ...
    Private Overloads Sub AssignParameterValues(ByVal commandParameters() As OracleParameter, ByVal dataRow As DataRow)
    ...
    Private Overloads Sub AssignParameterValues(ByVal commandParameters() As OracleParameter, ByVal parameterValues() As Object)
    ...
    Private Sub PrepareCommand(ByVal command As OracleCommand, _
    ...
    Private Function DevuelveParametros(ByVal commandType As CommandType, ByRef parametros As ArrayList) As OracleParameter()


        If Not parametros Is Nothing AndAlso parametros.Count > 0 Then
            Dim aParam(parametros.Count) As OracleParameter
            Dim i As Short

            For i = 0 To parametros.Count - 1
                If TypeOf parametros(i) Is OracleParameter Then
            ...
            Return aParam
        Else
            Return CType(Nothing, OracleParameter())
        End If

    End Function

    'Este método crea un Sqlparameter a partir de un IDBDataParameter
    Private Function CreaParametro(ByVal parametro As IDbDataParameter) As OracleParameter
        Dim oParam As New OracleParameter
...
#Region "Execute DataSet"
    ...
    Private Overloads Function ExecuteDatasets(ByVal connection As OracleConnection, _
                                                    ByVal commandType As CommandType, _
                                                    ByVal commandText As String, _
        ...
        Dim dataAdatpter As OracleDataAdapter
    ...
    ' -commandParameters - an array of SqlParamters used to execute the command
    ' Returns: A dataset containing the resultset generated by the command
    Private Overloads Function ExecuteDatasets(ByVal transaction As OracleTransaction, _
                                                    ByVal commandType As CommandType, _
                                                    ByVal commandText As String, _
                                                    ByVal commandParameters() As OracleParameter, _
                                                    ByVal tableNames As String()) As DataSet
...
#Region "ExecuteNonQuery"
    ...
    Private Overloads Function ExecuteNonQuerys(ByVal connection As OracleConnection, _
                                                     ByVal commandType As CommandType, _
                                                     ByVal commandText As String, _
                                                     ByVal commandParameters() As OracleParameter) As Integer
    ...
    ' -commandParameters - an array of SqlParamters used to execute the command 
    ' Returns: An int representing the number of rows affected by the command 
    Private Overloads Function ExecuteNonQuerys(ByVal transaction As OracleTransaction, _
                                                     ByVal commandType As CommandType, _
                                                     ByVal commandText As String, _
                                                     ByVal commandParameters() As OracleParameter) As Integer
...
#Region "ExecuteScalar"
    ...
    Private Overloads Function ExecuteScalares(ByVal connection As OracleConnection, _
                                                   ByVal commandType As CommandType, _
                                                   ByVal commandText As String, _
                                                   ByVal commandParameters() As OracleParameter) As Object
    ...
    ' -commandParameters - an array of SqlParamters used to execute the command 
    ' Returns: An object containing the value in the 1x1 resultset generated by the command 
    Private Overloads Function ExecuteScalares(ByVal transaction As OracleTransaction, _
                                                   ByVal commandType As CommandType, _
                                                   ByVal commandText As String, _
                                                   ByVal commandParameters() As OracleParameter) As Object
...
#Region "ExecuteReader"
    ...
    Public Overrides Function ExecuteReader(ByRef Request As DAABRequest) As DAABDataReader
        ...
        Dim oDataReaderSQL As DAAB.DAABOracleDataReader
        ...
        Try
            ...
            drSQL = ExecuteReaders(m_conecSQL, CType(Nothing, OracleTransaction), Request.CommandType, Request.Command, aparam)

            oDataReaderSQL = New DAAB.DAABOracleDataReader
    ...
    Private Overloads Function ExecuteReaders(ByVal connection As OracleConnection, _
                                                    ByVal transaction As OracleTransaction, _
                                                    ByVal commandType As CommandType, _
                                                    ByVal commandText As String, _
                                                    ByVal commandParameters() As OracleParameter) As OracleDataReader
...
#Region "FillDataset"
    ...
    Public Overrides Sub FillDataset(ByRef Request As DAABRequest)
        ...
        Try
            ...
            Else
                FillDatasets(m_conecSQL, CType(Nothing, OracleTransaction), Request.CommandType, Request.Command, Request.RequestDataSet, Request.TableNames, aparam)
            End If
    ...
    ' -commandParameters: An array of SqlParamters used to execute the command
    Private Overloads Sub FillDatasets(ByVal connection As OracleConnection, ByVal transaction As OracleTransaction, ByVal commandType As CommandType, _
...
#Region "UpdateDataset"
    Public Overrides Sub UpdateDataSet(ByRef RequestInsert As DAABRequest, _
        ...
        Dim cmdCommandInsert As OracleCommand
        Dim cmdCommandUpdate As OracleCommand
        Dim cmdCommandDelete As OracleCommand
        ...
        Try
            ...
            Dim aparamInsert As OracleParameter() = DevuelveParametros(RequestInsert.CommandType, RequestInsert.Parameters)
            ...
            Dim aparamUpdate As OracleParameter() = DevuelveParametros(RequestUpdate.CommandType, RequestUpdate.Parameters)
            ...
            Dim aparamDelete As OracleParameter() = DevuelveParametros(RequestDelete.CommandType, RequestDelete.Parameters)
    ...
    Public Sub UpdateDatasets(ByVal insertCommand As OracleCommand, _
                                ByVal deleteCommand As OracleCommand, _
                                ByVal updateCommand As OracleCommand, _
