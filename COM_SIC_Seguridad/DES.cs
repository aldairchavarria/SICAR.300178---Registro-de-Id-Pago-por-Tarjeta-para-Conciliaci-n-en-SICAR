...
namespace COM_SIC_Seguridad
{
	...
	public class DES
	{
		...
		private object[, , , , , ,] m_sBox = new object[8, 2, 2, 2, 2, 2, 2];
		...
		public DES(string palabraSecreta) : this()
		{
			this.Key = palabraSecreta;
		}
		#endregion
		#region [ Properties ]
		...
		public void DecryptByte(ref byte[] ByteArray, string Key )
		{
			...
			{
				throw new Exception("Incorrect size descriptor in DES decryption");
			}
			...
			redimensionar(ref ByteArray,OrigLen);
...
//		private void redimensionar(ref byte[] oldarray, int newSize) 
//		{
//			int oldsize = oldarray.Length;
//			System.Type elementtype = oldarray.GetType().GetElementType();
//			System.Array newArray  = (byte[]) System.Array.CreateInstance(elementtype,newSize);
...
//
//		}
		private void redimensionar(ref byte[] ByteArray , int OrigLen) 
		{
			byte[] New_ByteArray = new byte[OrigLen];
			for (int i = 0, j = OrigLen; i < j; i++)
			{
